...
(function (factory) {
    ...
    $h = {
        ...
        defaultButtonCss: function (fill) {
            return 'btn-default btn-' + (fill ? '' : '') + 'secondary btn-sm me-2';
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tcss, tBtnDefault, tBtnLink, tBtnBrowse,
            ...
            tPreview = '<div class="file-preview {class}">\n' +
                '  {close}' +
                '  <div class="{dropClass} clearfix" style="margin:2px !important;padding:2px !important;">\n' +
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                ...
                '    {progress}\n{indicator}\n{actions}\n' +
                '</div>';
            tActions = '<div class="file-actions d-flex justify-content-center">\n' +
                '    <div class="file-footer-buttons d-flex justify-content-center">\n' +
            ...
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<button type="button"  style="padding:5px !important;" class="kv-file-remove {removeClass}" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n';
            // tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
            //     '{uploadIcon}</button>';
            tActionUpload = '';
            tActionRotate = '<button type="button" class="kv-file-rotate pad {rotateClass}" style="padding:5px !important;" title="{rotateTitle}">' +
                '{rotateIcon}</button>';
                // $(".pad").css({"padding":"5px !important"});
            // $('.pad > div').css('padding', "5px !important");
            tActionDownload = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" ' +
                'href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>';
            tActionZoom = '<button type="button"  style="padding:5px !important;" class="kv-file-zoom {zoomClass}" ' +
                'title="{zoomTitle}">{zoomIcon}</button>';
            tActionDrag = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>';
            // tIndicator = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>';
            tIndicator = '';
            tTagBef = '<div class="file-preview-frame {frameClass}" style="margin:2px !important;padding:2px !important;" id="{previewId}" data-fileindex="{fileindex}"' +
                ' data-fileid="{fileid}" data-filename="{filename}" data-template="{template}" data-zoom="{zoomData}"';
            tTagBef1 = tTagBef + '><div class="kv-file-content d-flex justify-content-center">\n';
            tTagBef2 = tTagBef + ' title="{caption}"><div class="kv-file-content d-flex justify-content-center">\n';
            tTagAft = '</div>{footer}\n{zoomCache}</div>\n';
            tGeneric = '{content}\n';
            tStyle = ' {style}';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showDrag: true,
                    showRotate: true,
                    removeIcon: '<i class="bi-trash fs-5 eyc" style="padding-right:0px !important;"></i>',
                    removeClass: defBtnCss1,
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="bi-upload eyc"></i>',
                    uploadClass: defBtnCss1,
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="bi-cloud-arrow-up-fill eyc"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="bi-download eyc"></i>',
                    downloadClass: defBtnCss1,
                    downloadTitle: 'Download file',
                    rotateIcon: '<i class="bi-arrow-clockwise fs-5 eyc" style="padding-right:0px !important;"></i>',
                    rotateClass: defBtnCss1,
                    rotateTitle: 'Rotate 90 deg. clockwise',
                    zoomIcon: '<i class="bi-zoom-in fs-5 eyc" style="padding-right:0px !important;"></i>',
                    zoomClass: defBtnCss1,
                    zoomTitle: 'View Details',
                    dragIcon: '<i class="bi-arrows-move eyc"></i>',
                    dragClass: 'text-primary',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="bi-plus-lg text-warning eyc"></i>',
                    indicatorSuccess: '<i class="bi-check-lg text-success eyc"></i>',
                    indicatorError: '<i class="bi-exclamation-lg text-danger eyc"></i>',
                    indicatorLoading: '<i class="bi-hourglass-bottom text-muted eyc"></i>',
                    indicatorPaused: '<i class="bi-pause-fill text-primary eyc"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="bi-chevron-left eyc"></i>',
            next: '<i class="bi-chevron-right eyc"></i>',
            rotate: '<i class="bi-arrow-clockwise eyc"></i>',
            toggleheader: '<i class="bi-arrows-expand eyc"></i>',
            fullscreen: '<i class="bi-arrows-fullscreen eyc"></i>',
            borderless: '<i class="bi-arrows-angle-expand eyc"></i>',
            close: '<i class="bi-x-lg eyc"></i>'
        },
