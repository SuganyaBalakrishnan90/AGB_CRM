...
(function(S, M) {
    ...
    M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a) {
        ...
        function w(d, b, f) {
            ...
            if ("height" === b) return Math.max(0, Math.min(d.offsetHeight, d.scrollHeight) - (w(d, "padding-top", !0) || 0) - (w(d, "padding-bottom",
                !0) || 0));
        ...
        function e(d, b, f, e) {
            ...
            if (u.createEvent && (d.dispatchEvent || d.fireEvent && d !== a)) {
                ...
                let e = d,
                    E = !1;
                for (; e.hcEvents;) Object.hasOwnProperty.call(e, "hcEvents") && e.hcEvents[b] &&
                    (k.length && (E = !0), k.unshift.apply(k, e.hcEvents[b])), e = Object.getPrototypeOf(e);
        ...
        H = {
            ...
            normalizeTickInterval: function(b, k, f, e, p) {
                ...
                for (e = 0; e < k.length && !(d = k[e], p && d * f >= b || !p && E <= (k[e] + (k[e + 1] || k[e])) /
                        2); e++);
        ...
        class D {
            ...
            init(a) {
                ...
                if ("object" === typeof a && "undefined" !== typeof a.stops) this.stops = a.stops.map(c => new D(c[1]));
                    ...
                    if (!z)
                        for (c = D.parsers.length; c-- && !z;) t = D.parsers[c],
            ...
            brighten(a) {
                ...
                if (this.stops) this.stops.forEach(function(t) {
                    ...
                    for (let t =
                            0; 3 > t; t++) z[t] += A(255 * a), 0 > z[t] && (z[t] = 0), 255 < z[t] && (z[t] = 255);
                return this
            }
            setOpacity(a) {
                this.rgba[3] = a;
        ...
        class q {
            ...
            getTimeTicks(g, w, l, q) {
                ...
                if (L(w)) {
                    ...
                    h >= r.minute &&
                        e.set("Minutes", p, h >= r.hour ? 0 : b * Math.floor(e.get("Minutes", p) / b));
    ...
    M(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, G) {
        ...
        class z {
            ...
            run(a, v, c) {
                ...
                a !== v || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date, this.start = a, this.end =
                    v, this.unit = c, this.now = this.start, this.pos = 0, l.elem = this.elem, l.prop = this.prop, l() && 1 === z.timers.push(l) && h(q)) : (delete r.curAnim[this.prop], r.complete && 0 === Object.keys(r.curAnim).length && r.complete.call(this.elem))
            }
            step(a) {
                const v = +new Date,
                    c = this.options,
                ...
                n.attr && !n.element ? a = !1 : a || v >= l + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), q = h[this.prop] = !0, C(h, function(g) {
                    !0 !== g && (q = !1)
                }), q && r && r.call(n), a = !1) : (this.pos = c.easing((v - this.startTime) /
                    l), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a = !0);
                return a
            }
            initPath(a, v, c) {
                function n(e, m) {
    ...
    M(a, "Core/Animation/AnimationUtilities.js", [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function(a, y) {
        ...
        return {
            ...
            animObject: x,
            getDeferredAnimation: function(c,
                l, a) {
                const q = x(l);
                let g = 0,
                    w = 0;
            ...
            (function(a) {
                function y(a, t, v) {
                    ...
                    for (a = a.map(g => ({
                        ...
                        for (h = a.length; h--;) n = a[h], r = (Math.min.apply(0, n.targets) + Math.max.apply(0, n.targets)) /
                    ...
                    a.some(g => {
                        ...
                        return (g.targets || []).some(() => {
                            c[h].pos = g.pos + a;
                            if ("undefined" !== typeof v && Math.abs(c[h].pos - c[h].target) > v) return c.slice(0, h + 1).forEach(e => delete e.pos), c.reducedLen = (c.reducedLen || t) - .1 * t, c.reducedLen >
                                .1 * t && y(c, t, v), !0;
                            a += c[h].size;
                            h++;
                            return !1
        ...
        class N {
            ...
            align(b, d, k) {
                ...
                if (b) {
                    if (this.alignOptions =
                        b, this.alignByTranslate = d, !k || p(k)) this.alignTo = g = k || "renderer", w(m, this), m.push(this), k = void 0
            ...
            dashstyleSetter(b) {
                ...
                if (b = b && b.toLowerCase()) {
                    const e = b.replace("shortdashdotdot", "3,1,1,1,1,1,").replace("shortdashdot", "3,1,1,1").replace("shortdot", "1,1,").replace("shortdash", "3,1,").replace("longdash", "8,3,").replace(/dot/g,
            ...
            destroy() {
                ...
                if (d.clipPath && e) {
                    ...
                    [].forEach.call(e.querySelectorAll("[clip-path],[CLIP-PATH]"), function(d) {
                        -1 <
                            d.getAttribute("clip-path").indexOf(b.element.id) && d.removeAttribute("clip-path")
                    });
            ...
            dSetter(b, d, f) {
                e(b) && ("string" === typeof b[0] && (b = this.renderer.pathToSegments(b)),
                    this.pathArray = b, b = b.reduce((b, d, f) => d && d.join ? (f ? b + " " : "") + d.join(" ") : (d || "").toString(), ""));
            ...
            updateTransform() {
                ...
                k && a.push("rotate(" + k + " " + f(this.rotationOriginX, b.getAttribute("x"), 0) + " " + f(this.rotationOriginY,
                    b.getAttribute("y") || 0) + ")");
        ...
        class t extends a {
            ...
            css(v) {
                if (v) {
                    ...
                    this.text.css(c);
                    "fontSize" in c ||
                        "fontWeight" in c ? this.updateTextPadding() : ("width" in c || "textOverflow" in c) && this.updateBoxSize()
                }
            ...
            updateBoxSize() {
                ...
                this.needsBox && !a.textPath && (this.box || (a = this.box = this.symbolKey ? this.renderer.symbol(this.symbolKey) : this.renderer.rect(), a.addClass(("button" === this.className ? "" : "highcharts-label-box") + (this.className ? " highcharts-" + this.className + "-box" : "")), a.add(this)),
                    a = this.getCrispAdjust(), c.x = a, c.y = (this.baseline ? -this.baselineOffset : 0) + a, c.width = Math.round(this.width), c.height = Math.round(this.height), this.box.attr(L(c, this.deferredAttr)), this.deferredAttr = {})
            }
            updateTextPadding() {
                const a = this.text;
                if (!a.textPath) {
    ...
    M(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function(a) {
        ...
        return {
            ...
            callout: function(a, t, v, c, n) {
                ...
                if (!D(h)) return q;
                a + h >= v ? n > t + l && n < t + c - l ? q.splice(3, 1, ["L", a + v, n - 6], ["L", a + v + 6, n], ["L", a + v, n + 6], ["L", a + v, t +
                    c - r
                ]) : q.splice(3, 1, ["L", a + v, c / 2], ["L", h, n], ["L", a + v, c / 2], ["L", a + v, t + c - r]) : 0 >= a + h ? n > t + l && n < t + c - l ? q.splice(7, 1, ["L", a, n + 6], ["L", a - 6, n], ["L", a, n - 6], ["L", a, t + r]) : q.splice(7, 1, ["L", a, c / 2], ["L", h, n], ["L", a, c / 2], ["L", a, t + r]) : n && n > c && h > a + l && h < a + v - l ? q.splice(5, 1, ["L", h + 6, t + c], ["L", h, t + c + 6], ["L", h - 6, t + c], ["L", a + r, t + c]) : n && 0 > n && h > a + l && h < a + v - l && q.splice(1, 1, ["L", h - 6, t], ["L", h, t - 6], ["L", h + 6, t], ["L", v - r, t]);
                return q
            },
                ...
                if (g) {
                    var w = (q, e) => {
                            ...
                            if (this.ellipsis) m && this.truncate(q, m, void 0, 0, Math.max(0, g - .8 * l), (b, f) => b.substring(0, f) + "\u2026");
                                ...
                                for (; u.length;) u.length && !this.noWrap && 0 < b && (m.push(q.textContent ||
                                    ""), q.textContent = u.join(" ").replace(/- /g, "-")), this.truncate(q, void 0, u, 0 === b ? f || 0 : 0, g, (b, f) => u.slice(0, f).join(" ").replace(/- /g, "-")), f = a.actualWidth, b++;
                                p.forEach(b => {
                                    e.insertBefore(b, q)
                                });
                                m.forEach(b => {
        ...
        class K {
            ...
            symbol(d, f, k, a, B, c) {
                const K = this,
                    ...
                    l = h && this.symbols[h];
                let P, Q, r, H;
                if (l) "number" === typeof f && (Q = l.call(this.symbols, Math.round(f || 0), Math.round(k || 0), a || 0, B ||
                    0, c)), P = this.path(Q), K.styledMode || P.attr("fill", "none"), b(P, {
                    symbolName: h || void 0,
                    x: f,
                    y: k,
                    width: a,
                    ...
                    ["width", "height"].forEach(function(d) {
                        b[d + "Setter"] = function(b, d) {
                            ...
                            if (p(b)) {
                                let p = 1;
                                c && "within" ===
                                    c.backgroundSize && a && m ? (p = Math.min(a / B, m / K), e(k, {
            ...
            text(b, d, f, k) {
                ...
                if (!k ||
                    this.forExport && !this.allowHTML) b.xSetter = function(b, d, f) {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === c.tagName) {
                        ...
                        if (p !== this.oldTextWidth) {
                            ...
                            (p > this.oldTextWidth ||
                                u > p) && (/[ \-]/.test(c.textContent || c.innerText) || "ellipsis" === c.style.textOverflow) && (z(c, {
            ...
            html(c, n, r) {
                ...
                l.textSetter = function(c) {
                    c !== this.textStr && (delete this.bBox, delete this.oldTextWidth,
                        a.setElementHTML(this.element, z(c, "")), this.textStr = c, l.doTransform = !0)
                };
                g(l, l.element.style);
    ...
    M(a, "Core/Axis/Tick.js", [a["Core/FormatUtilities.js"],
        ...
        class h {
            ...
            renderGridLine(a, c, h) {
                ...
                "minor" === this.type && (f = n.minorGridLineWidth, d = n.minorGridLineColor,
        ...
        class U {
            ...
            setOptions(d) {
                this.options = b(y.defaultXAxisOptions, "yAxis" === this.coll &&
                    y.defaultYAxisOptions, [y.defaultTopAxisOptions, y.defaultRightAxisOptions, y.defaultBottomAxisOptions, y.defaultLeftAxisOptions][this.side], b(v[this.coll], d));
                ...
                m(this, "getSeriesExtremes", null, function() {
                    ...
                    b.series.forEach(function(a) {
                        if (a.visible || !d.options.chart.ignoreHiddenSeries) {
                            ...
                            else if (a = a.applyExtremes(), p(a.dataMin) && (c = a.dataMin, b.dataMin = Math.min(k(b.dataMin, c), c)), p(a.dataMax) && (m = a.dataMax, b.dataMax = Math.max(k(b.dataMax,
                                    m), m)), g(d) && (b.threshold = d), !e.softThreshold || b.positiveValuesOnly) b.softThreshold = !1
                        }
                    })
                });
            ...
            translate(b, d, f, a, k, e) {
                ...
                d ? (e = (b * g + K - B) / a + m, k && (e = c.lin2val(e))) : (k &&
                    (b = c.val2lin(b)), b = g * (b - m) * a, e = (c.isRadial ? b : q(b)) + K + g * B + (p(e) ? a * e : 0));
                return e
            }
            toPixels(b, d) {
            ...
            getMinorTickPositions() {
                ...
                if (e && e / a < this.len / 3) {
                    ...
                    if (e) this.paddedTicks.forEach(function(b,
                        d, f) {
            ...
            adjustForMinRange() {
                ...
                let e, c = 0,
                    p, m, h, n, u;
                this.isXAxis && "undefined" === typeof this.minRange && !d && (g(b.min) || g(b.max) || g(b.floor) ||
                    g(b.ceiling) ? this.minRange = null : (this.series.forEach(function(b) {
                        h = b.xData;
                ...
                0 < d.length && (Object.keys(d.keys).forEach(function(b) {
                    ...
                    d.data.forEach(function(a, f) {
                        ...
                        a && a.options && "undefined" !==
                            typeof a.name && (e = b.nameToX(a), "undefined" !== typeof e && e !== a.x && (a.x = e, d.xData[f] = e))
                    })
                }))
            }
            setAxisTranslation() {
                ...
                if (e || f || c) p = b.getClosest(), a ? (g = a.minPointOffset, h = a.pointRangePadding) : b.series.forEach(function(d) {
                    ...
                    c = Math.max(c, a);
                    if (!b.single || f) d = d.is("xrange") ? !e : e, g = Math.max(g, d &&
                        H(m) ? 0 : a / 2), h = Math.max(h, d && "on" === m ? 0 : a)
            ...
            setTickInterval(b) {
                ...
                if (c) {
                    ...
                    (this.dataMin >= E ? (H = E, u = 0) : this.dataMax <= E && (w = E, n = 0)), this.min = k(O, H, this.dataMin), this.max = k(N, w, this.dataMax);
                ...
                !(l ||
                    this.axisPointRange || this.stacking && this.stacking.usePercentage || c) && g(this.min) && g(this.max) && (d = this.max - this.min) && (!g(O) && u && (this.min -= d * u), !g(N) && n && (this.max += d * n));
                ...
                K && g(this.dataMin) && (E = E || 0, !g(O) && this.min < E && this.dataMin >= E ? this.min = this.options.minRange ?
                    Math.min(E, this.max - this.minRange) : E : !g(N) && this.max > E && this.dataMax <= E && (this.max = this.options.minRange ? Math.max(E, this.min + this.minRange) : E));
                ...
                this.tickInterval = this.min === this.max || "undefined" === typeof this.min || "undefined" === typeof this.max ? 1 : c && this.linkedParent && !r && h === this.linkedParent.options.tickPixelInterval ? r = this.linkedParent.tickInterval : k(r,
                    this.tickAmount ? (this.max - this.min) / Math.max(this.tickAmount - 1, 1) : void 0, l ? 1 : (this.max - this.min) * h / Math.max(this.len, h));
                if (e && !b) {
            ...
            alignToOthers() {
                ...
                if ((!1 !== this.chart.options.chart.alignTicks && f.alignTicks ||
                        a) && !1 !== f.startOnTick && !1 !== f.endOnTick && !b.logarithmic) {
                    const f = b => {
                            const {
                                horiz: d,
                                options: f
            ...
            setScale() {
                ...
                f || b || d || this.isLinked || this.forceRedraw || this.userMin !== (this.old && this.old.userMin) || this.userMax !== (this.old && this.old.userMax) || this.alignToOthers() ? (this.stacking && (this.stacking.resetStacks(), this.stacking.buildStacks()), this.forceRedraw = !1, this.userMinRange || (this.minRange = void 0), this.getSeriesExtremes(), this.setTickInterval(), this.isDirty || (this.isDirty = f || this.min !== (this.old && this.old.min) || this.max !== (this.old && this.old.max))) :
            ...
            renderUnsquish() {
                ...
                f.forEach(function(b) {
                    const d = (b = a[b]) && b.label,
                        f = k.width,
                        e = {};
                    d && (d.attr(g), b.shortenLabel ? b.shortenLabel() : u && !f && "nowrap" !== k.whiteSpace && (u < d.textPxLength || "SPAN" === d.element.tagName) ? (e.width = u + "px", l || (e.textOverflow = d.specificTextOverflow ||
                        n), d.css(e)) : d.styles && d.styles.width && !e.width && !f && d.css({
                        width: null
            ...
            getOffset() {
                ...
                if (!b.axisGroup) {
                    const d = (b, d, f) => r.g(b).attr({
                        zIndex: f
                    }).addClass(`highcharts-${u.toLowerCase()}${d} ` + (this.isRadial ?
                ...
                E || b.isLinked ? (l.forEach(function(d) {
                    ...
                    b.labelOffset = F * (b.opposite ? -1 : 1)) : d(h, function(b, d) {
                    b.destroy();
                    delete h[d]
                });
            ...
            render() {
                ...
                if (b.hasData() || k) {
                    ...
                    c.length && (c.forEach(function(f, a) {
                        b.renderTick(f, a, d)
                    }), E && (0 === b.min || b.single) && (h[-1] || (h[-1] = new C(b, -1, null,
                        !0)), h[-1].render(-1)));
            ...
            drawCrosshair(b, d) {
                ...
                if (f && !1 !== (g(d) || !a)) {
                    a ? g(d) && (p = k("colorAxis" !== this.coll ? d.crosshairPos : null, this.isXAxis ? d.plotX : this.len -
                        d.plotY)) : p = b && (this.horiz ? b.chartX - this.pos : this.len - b.chartY + this.pos);
                    if (g(p)) {
                        var l = {
        ...
        (function(y) {
            ...
            class v {
                ...
                getLogTickPositions(a, n, r, l) {
                    ...
                    } else n = this.lin2log(n), r = this.lin2log(r), a = l ? c.getMinorTickInterval() : g.tickInterval, a = L("auto" === a ? null : a, this.minorAutoInterval, g.tickPixelInterval / (l ? 5 : 1) * (r - n) / ((l ? q / c.tickPositions.length :
                        q) || 1)), a = G(a), w = c.getLinearTickPositions(a, n, r).map(this.log2lin), l || (this.minorAutoInterval = a / 5);
                    l || (c.tickInterval = a);
                    return w
                }
                lin2log(a) {
    ...
    M(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, y, G, L, A) {
        ...
        class u {
            ...
            getPosition(a, e, b) {
                ...
                g = c => {
                    const k = "x" === c;
                    return [c, k ? h : l, k ? a : e].concat(m ? [k ? a * u.scaleX : e * u.scaleY, k ? u.left -
                        d + (b.plotX + f.plotLeft) * u.scaleX : u.top - d + (b.plotY + f.plotTop) * u.scaleY, 0, k ? h : l
                    ] : [k ? a : e, k ? b.plotX + f.plotLeft : b.plotY + f.plotTop, k ? f.plotLeft : f.plotTop, k ? f.plotLeft + f.plotWidth : f.plotTop + f.plotHeight])
                };
                let n = g("y"),
                    r = g("x"),
                    q;
            ...
            move(a, e, b, f) {
                const d = this,
                    c = d.now,
                    m = !1 !== d.options.animation && !d.isHidden && (1 < Math.abs(a -
        ...
        class H {
                    ...
                    const e = d.hoverPoints,
                        ...
                        p = () => {
                            if (a.graphic || a.graphics ||
                                a.dataLabel || a.dataLabels) u(a), a.destroyElements();
            ...
            optionsToObject(b) {
                ...
                if (g(b) || null === b) m[e[0]] = b;
                    ...
                    for (!d && b.length > c && (a = typeof b[0], "string" === a ? m.name = b[0] : "number" === a &&
                            (m.x = b[0]), p++); l < c;) d && "undefined" === typeof b[p] || (0 < e[l].indexOf(".") ? H.prototype.setNestedProperty(m, b[p], e[l]) : m[e[l]] = b[p]), p++, l++;
            ...
            setState(b, f) {
                ...
                if (!(b === this.state && !f || this.selected && "select" !== b || !1 === m.enabled || b && (u || h && !1 === l.enabled) || b && q.states && q.states[b] && !1 === q.states[b].enabled)) {
                    ...
                    if (this.graphic && !this.hasMockGraphic) {
                        ...
                        if (b && l) {
                            ...
                            if (v)
                                ...
                                else p && (d.stateMarkerGraphic = B = w.renderer.symbol(p, v.x, v.y, v.width, v.height).add(d.markerGroup),
                                    B.currentSymbol = p);
                    ...
                    m && m.size && B && "hidden" !== v && !this.isCluster ? (t || (d.halo = t = w.renderer.path().add(B.parentGroup)), t.show()[f ? "animate" : "attr"]({
                        ...
                        "class": "highcharts-halo highcharts-color-" + e(this.colorIndex, d.colorIndex) + (this.className ? " " +
                            this.className : ""),
                        visibility: v,
                        zIndex: -1
            ...
            class F {
                    ...
                    if (!t || !t.touch)
                        if (q < g ? q = g : q > g + b && (q = g + b), w < l ? w = l : w > l + f && (w = l + f), this.hasDragged = Math.sqrt(Math.pow(d - q, 2) + Math.pow(k - w, 2)), 10 < this.hasDragged) {
                            ...
                            !e.hasCartesianSeries && !e.mapView || !this.zoomX && !this.zoomY ||
                                !g || r || t || (this.selectionMarker = t = e.renderer[b](), t.attr({
                ...
                onContainerClick(a) {
                    ...
                    e.cancelClick || (g && this.inClass(a.target, "highcharts-tracker") ? (r(g.series, "click", c(a, {
                        ...
                        g.firePointEvent("click", a)) : (c(a, this.getCoordinates(a)), e.isInsidePlot(a.chartX - p, a.chartY - h, {
                        visiblePlotOnly: !0
                    }) && r(e, "click", a)))
                }
                ...
                onContainerMouseLeave(a) {
                    ...
                    c && a.relatedTarget && !this.inClass(a.relatedTarget,
                        "highcharts-tooltip") && (c.pointer.reset(), c.pointer.chartPosition = void 0)
                }
                ...
                onContainerMouseMove(a) {
                    ...
                    c.openMenu || !this.inClass(a.target, "highcharts-tracker") && !c.isInsidePlot(a.chartX - c.plotLeft, a.chartY - c.plotTop, {
                        visiblePlotOnly: !0
                    }) || e && e.shouldStickOnContact(a) || (this.inClass(a.target, "highcharts-no-tooltip") ?
                ...
                scaleGroups(a, c) {
                    ...
                    e.series.forEach(function(g) {
                        ...
                        g.group && (g.xAxis && g.xAxis.zoomEnabled || e.mapView) && (g.group.attr(m), g.markerGroup && (g.markerGroup.attr(m), g.markerGroup.clip(c ? e.clipRect : null)), g.dataLabelsGroup &&
                ...
                touch(a, c) {
                    ...
                    1 === a.touches.length ? (a = this.normalize(a), (m = e.isInsidePlot(a.chartX - e.plotLeft, a.chartY - e.plotTop, {
                        visiblePlotOnly: !0
                    })) && !e.openMenu ? (c && this.runPointActions(a), "touchmove" === a.type && (c = this.pinchDown, g = c[0] ? 4 <= Math.sqrt(Math.pow(c[0].chartX - a.chartX, 2) + Math.pow(c[0].chartY -
                        a.chartY, 2)) : !1), w(g, !0) && this.pinch(a)) : c && this.reset()) : 2 === a.touches.length && this.pinch(a)
                }
                touchSelect(a) {
        ...
        class H {
            ...
            setOptions(b) {
                ...
                this.chart.styledMode || (this.itemStyle =
                    b.itemStyle, this.itemHiddenStyle = F(this.itemStyle, b.itemHiddenStyle));
            ...
            renderItem(b) {
                ...
                I || (a.group = c.g("legend-item").addClass("highcharts-" + u.type + "-series highcharts-color-" + b.colorIndex + (P ? " " + P : "") + (q ? " highcharts-series-" + b.index : "")).attr({
                    ...
                    align: r ? "left" : "right",
                    zIndex: 2
                }).add(a.group), this.baseline || (this.fontMetrics = c.fontMetrics(I), this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop,
                    I.attr("y", this.baseline), this.symbolHeight = e(g.symbolHeight, this.fontMetrics.f), g.squareSymbol && (this.symbolWidth = e(g.symbolWidth, Math.max(this.symbolHeight, 16)), w = this.symbolWidth + h + n + (t ? 20 : 0), r && I.attr("x", this.symbolWidth + h))), u.drawLegendSymbol(this, b), this.setItemEvents && this.setItemEvents(b, I, B));
            ...
            proximatePositions() {
                ...
                this.allItems.forEach(function(c) {
                    ...
                    c.yAxis && (c.xAxis.options.reversed && (e = !e), c.points && (f = g(e ? c.points : c.points.slice(0).reverse(), function(b) {
                        ...
                        c.legendItem.label.getBBox().height + this.itemMarginBottom, k = c.yAxis.top - b.plotTop, c.visible ? (f = f ? f.plotY : c.yAxis.height, f += k - .3 * e) : f = k + c.yAxis.height, a.push({
                            target: f,
                            size: e,
                            item: c
                        }))
            ...
            align(b = this.chart.spacingBox) {
                const a = this.chart,
                    d = this.options;
                let c = b.y;
                /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0] ? c += a.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < a.titleOffset[2] &&
                    (c -= a.titleOffset[2]);
                c !== b.y && (b = F(b, {
                    y: c
                }));
            ...
            handleOverflow(b) {
                ...
                l && (m = Math.min(m, l));
                u.length = 0;
                b && 0 < m && b > m && !1 !== n.enabled ? (this.clipHeight = P = Math.max(m -
                    20 - this.titleHeight - p, 0), this.currentPage = e(this.currentPage, 1), this.fullHeight = b, w.forEach((b, a) => {
                    v = b.legendItem || {};
                    b = v.y || 0;
                    ...
                    c.symbol("triangle", 0, 0, q, q).add(x), B("upTracker").on("click", function() {
                        a.scroll(-1, r)
    ...
    M(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"],
        ...
        class da {
            ...
            getArgs(b, a, d) {
                P(b) || b.nodeName ? (this.renderTo = b, this.init(a, d)) : this.init(b,
                    a)
            }
            init(b, a) {
            ...
            redraw(b) {
                ...
                d.forEach(function(b) {
                    b.isDirty &&
                        ("point" === b.options.legendType ? ("function" === typeof b.updateTotals && b.updateTotals(), B = !0) : e && (e.labelFormatter || e.labelFormat) && (B = !0));
            ...
            layOutTitles(b) {
                ...
                !this.isDirtyBox && f && (this.isDirtyBox = this.isDirtyLegend = f, this.hasRendered &&
            ...
            linkSeries(b) {
                ...
                d.forEach(function(b) {
                    ...
                    P(d) &&
                        (d = ":previous" === d ? a.series[b.index - 1] : a.get(d)) && d.linkedParent !== b && (d.linkedSeries.push(b), b.linkedParent = d, d.enabledDataSorting && b.setDataSortingOptions(), b.visible = R(b.options.visible, d.options.visible, b.visible))
                });
                        ...
                        if (a.options.panningEnabled && !a.options.isInternal) {
                            ...
                            !p || a.isXAxis || q && !q.isDirty || a.series.forEach(function(b) {
                                ...
                                Y(a.dataMin) && Y(a.dataMax) && (q.startMin =
                                    Math.min(R(b.options.threshold, Infinity), a.dataMin, q.startMin), q.startMax = Math.max(R(b.options.threshold, -Infinity), a.dataMax, q.startMax))
                            });
                            ...
                            a.isOrdinal || (h = p - m, 0 < h && (n += h, m = p), h = n - B, 0 < h && (n = B, m -= h), a.series.length && m !== l.min && n !== l.max && m >= p && n <= B && (a.setExtremes(m, n, !1, !1, {
                                ...
                                m !== p && n !== B && e.match("y") && (d.showResetZoom(), a.displayBtn = !1), g = !0), f[c] = k)
                        }
                    });
                    V(f, (b, a) => {
                        d[a] = b
    ...
    M(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesDefaults.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function(a, y, G, L, A, D, C, z, t, v) {
        ...
        class Y {
            ...
            autoIncrement(b) {
                ...
                c && E(b) && (g *= b);
                d && (a = new f.Date(e), "day" === d ? f.set("Date", a, f.get("Date", a) + g) : "month" === d ? f.set("Month",
                    a, f.get("Month", a) + g) : "year" === d && f.set("FullYear", a, f.get("FullYear", a) + g), g = a.getTime() - e);
                if (c && E(b)) return e + g;
                this.xIncrement = e + g;
                return e
            }
            ...
            findPointIndex(b, a) {
                ...
                if (c) g = this.chart.get(c), g instanceof D && (k = g);
                    ...
                    if (k = a => !a.touched && a.index === b.index, g && g.matchByName ? k = a => !a.touched && a.name === b.name : this.options.relativeXValue && (k = a => !a.touched && a.options.x === b.x), k = d(e, k),
                        !k) return;
            ...
            generatePoints() {
                ...
                for (q = 0; q < g; q++) w = m + q, h ? (r = (new e).init(this, [d[q]].concat(M(c[q]))), r.dataGroup = this.groupMap[b + q], r.dataGroup.options && (r.options =
                    r.dataGroup.options, f(r, r.dataGroup.options), delete r.dataLabels)) : (r = u[w]) || "undefined" === typeof a[w] || (u[w] = r = (new e).init(this, a[w], d[q])), r && (r.index = h ? b + q : w, l[q] = r);
                this.options.keys = p;
                if (u && (g !== (n = u.length) || h))
            ...
            translate() {
                ...
                for (v = 0; v < l; v++) {
                    ...
                    d && this.visible && z && z[l] && (F = this.getStackIndicator(F, l, this.index), !k.isNull && F.key && (B = z[l], I = B.points[F.key]), B && N(I) && (O = I[0], P = I[1], O === w && F.key === z[l].base && (O = K(E(r) ? r : m.min)), m.positiveValuesOnly && p(O) &&
                        0 >= O && (O = void 0), k.total = k.stackTotal = K(B.total), k.percentage = p(k.y) && B.total ? k.y / B.total * 100 : void 0, k.stackY = P, this.irregularWidths || B.setOffset(this.pointXOffset || 0, this.barW || 0, void 0, void 0, void 0, this.xAxis)));
            ...
            update(a, d) {
                ...
                const v = !(this.hasDerivedData || t && t !== this.type || "undefined" !== typeof a.pointStart || "undefined" !== typeof a.pointInterval || "undefined" !== typeof a.relativeXValue || a.joinBy || a.mapData ||
                    c.hasOptionChanged("dataGrouping") || c.hasOptionChanged("pointStart") || c.hasOptionChanged("pointInterval") || c.hasOptionChanged("pointIntervalUnit") || c.hasOptionChanged("keys"));
                t = t || h;
                ...
                if (w[t]) {
                    if (p = t !== c.type, c.remove(!1, !1, !1, !0), p)
                        if (Object.setPrototypeOf) Object.setPrototypeOf(c,
                            w[t].prototype);
                        else {
            ...
            hasOptionChanged(b) {
                ...
                return c ? a !== c : a !==
                    K(d && d[this.type] && d[this.type][b], d && d.series && d.series[b], a)
            }
            onMouseOver() {
                const b = this.chart,
                    a = b.hoverSeries;
            ...
            setVisible(b, a) {
                const d = this,
                    ...
                    e = d.visible,
                    g = (d.visible = b = d.options.visible =
                        d.userOptions.visible = "undefined" === typeof b ? !e : b) ? "show" : "hide";
    ...
    M(a, "Extensions/ScrollablePlotArea.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Series/Series.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, y, G, L, A, D) {
        ...
        z(G, "afterSetChartSize",
            function(a) {
                ...
                if (!this.renderer.forExport) {
                    ...
                    } else l && (this.scrollablePixelsY = h = Math.max(0, l - this.chartHeight), v(h) && (this.scrollablePlotBox = this.renderer.scrollablePlotBox =
                        c(this.plotBox), this.plotBox.height = this.plotHeight += h, this.inverted ? this.clipBox.width += h : this.clipBox.height += h, n = {
                            2: {
                                name: "bottom",
                                value: h
                            }
        ...
        G.prototype.applyFixed = function() {
            ...
            a ? (this.fixedDiv = t("div", {
                ...
                top: 0
            }, null, !0), this.scrollingContainer && this.scrollingContainer.parentNode.insertBefore(this.fixedDiv, this.scrollingContainer), this.renderTo.style.overflow = "visible", this.fixedRenderer = c = new q(this.fixedDiv, this.chartWidth,
                this.chartHeight, this.options.chart.style), this.scrollableMask = c.path().attr({
            ...
            a && (h.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * h.scrollPositionX), h.scrollPositionY && (this.scrollingContainer.scrollTop =
            ...
            render(a) {
                ...
                this.label ? this.label.attr({
                    ...
                    visibility: "hidden"
                        ...
                        visibility: "hidden"
                    }, c.styledMode || (l.fill = r.backgroundColor, l.stroke = r.borderColor, l["stroke-width"] = r.borderWidth, this.label.css(r.style || {})),
    ...
    M(a, "Core/Axis/Stacking/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Axis/Stacking/StackItem.js"], a["Core/Utilities.js"]], function(a, y, G, L, A) {
        ...
        function n() {
            ...
            this.options.centerInCategory && (this.is("column") || this.is("columnrange")) &&
                !this.options.stacking && 1 < this.chart.series.length ? h.setStackedPoints.call(this, "group") : b && u(b.stacks, (a, c) => {
        ...
        function r(b) {
            ...
            if (c && (!0 === this.visible || !1 === a.options.chart.ignoreHiddenSeries)) {
                ...
                for (H = 0; H < l; H++) {
                    ...
                    C = t[C][J];
                    null !== z ? (C.points[A] = C.points[this.index] = [p(C.cumulative, r)], w(C.cumulative) || (C.base = A), C.touched = a.stacking.stacksTouched, 0 <
                        y.index && !1 === this.singleStacks && (C.points[A][0] = C.points[this.index + "," + J + ",0"][0])) : C.points[A] = C.points[this.index] = null;
        ...
        class H {
            ...
            buildStacks() {
                ...
                for (m = e; m--;) g =
                    a[c ? m : e - m - 1], g.setStackedPoints(), g.setGroupedPoints();
        ...
        (function(b) {
            ...
            b.compose = function(b, d, e) {
                ...
                A.pushUnique(a, e) && (b = e.prototype, b.getStackIndicator = t, b.modifyStacks = v, b.percentStacker = c, b.setGroupedPoints = n, b.setStackedPoints =
                    r)
            }
        })(b || (b = {}));
        return b
            ...
            getColumnMetrics() {
                ...
                !1 === c.grouping ? k = 1 : a.chart.series.forEach(function(b) {
                    const c = b.yAxis,
                        e = b.options;
                    let m;
                    b.type !== a.type || !b.visible && a.chart.options.chart.ignoreHiddenSeries ||
                        g.len !== c.len || g.pos !== c.pos || (e.stacking && "group" !== e.stacking ? (d = b.stackKey, "undefined" === typeof f[d] && (f[d] = k++), m = f[d]) : !1 !== e.grouping && (m = k++), b.columnIndex = m)
                });
            ...
            translate() {
                ...
                a.points.forEach(function(m) {
                    ...
                    k && Math.abs(E) < k && (E = k, p = !f.reversed && !m.negative ||
                        f.reversed && m.negative, g(d) && g(x) && m.y === d && x <= d && (f.min || 0) < d && (t !== x || (f.max || 0) <= d) && (p = !p), u = Math.abs(u - y) > k ? h - k : y - (p ? k : 0));
        ...
        (function(a) {
            function g(b, a, d, c,
                ...
                if (g && m) {
                    ...
                    }, q = [n.x - Number(a.attr("x")), n.y - Number(a.attr("y"))], k && this.xAxis && !p && this.setDataLabelStartPos(b, a, e, h, u), a[e ? "attr" : "animate"](u)) : (k && this.xAxis && !p && this.setDataLabelStartPos(b, a, e, h, c), a.align(d,
            ...
            function h(b, a) {
                var d = a.filter;
                return d ? (a = d.operator, b = b[d.property], d = d.value, ">" === a && b > d || "<" === a && b < d || ">=" === a &&
                    b >= d || "<=" === a && b <= d || "==" === a && b == d || "===" === a && b === d ? !0 : !1) : !0
            }
                ...
                if (t(q) || q.enabled || a._hasPointLabels) F = this.initDataLabels(J), b.forEach(b => {
                    ...
                    w.forEach((f, g) => {
                        ...
                        if (k) {
                            ...
                            x = f.style;
                            l = f.rotation;
                            d.styledMode || (x.color = r(f.color, x.color, a.color, "#000000"), "contrast" === x.color ? (b.contrastColor = e.getContrast(b.color ||
                                a.color), x.color = !D(v) && f.inside || 0 > v || c.stacking ? b.contrastColor : p) : delete b.contrastColor, c.cursor && (x.cursor = c.cursor));
                            q = {
                                r: f.borderRadius || 0,
                                rotation: l,
                                padding: f.padding,
                        ...
                        }!u || k && D(t) && !!u.div === !!f.useHTML && (u.rotation && f.rotation || u.rotation === f.rotation) || (w = !0, b.dataLabel = u = b.dataLabel &&
                            b.dataLabel.destroy(), b.dataLabels && (1 === b.dataLabels.length ? delete b.dataLabels : delete b.dataLabels[g]), g || delete b.dataLabel, m && (b.connector = b.connector.destroy(), b.connectors && (1 === b.connectors.length ? delete b.connectors : delete b.connectors[g])));
                        k && D(t) ? (u ? q.text = t : (b.dataLabels = b.dataLabels || [], u = b.dataLabels[g] = l ? e.text(t, 0, 0, f.useHTML).addClass("highcharts-data-label") : e.label(t, 0, 0, f.shape, null, null, f.useHTML, null, "data-label"), g || (b.dataLabel = u), u.addClass(" highcharts-data-label-color-" +
        ...
        class c extends y {
            ...
            setVisible(a, c) {
                ...
                a !== this.visible && (this.visible = this.options.visible = a = "undefined" === typeof a ? !this.visible : a, l.options.data[l.data.indexOf(this)] = this.options, ["graphic", "dataLabel", "connector"].forEach(c => {
                    ...
                    h.legend.colorizeItem(this, a), a || "hover" !== this.state || this.setState(""), n && (l.isDirty = !0), c && h.redraw())
            }
            slice(a, c, l) {
                const h = this.series;
                x(l, h.chart);
        ...
        C(c.prototype, {
            connectorShapes: {
                fixedOffset: function(a, c, l) {
                    ...
                    c = c.touchingSliceAt;
                    return [
                        ["M", a.x, a.y], l.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * h.x -
                            c.x, 2 * h.y - c.y, h.x, h.y
                        ] : ["L", h.x, h.y],
                        ["L", c.x, c.y]
                    ]
                },
        ...
        (function(h) {
            function g() {
                ...
                a.visible && (h.enabled || a._hasPointLabels) && (e.forEach(function(a) {
                    ...
                    a.dataLabel &&
                        (a.visible ? (x[a.half].push(a), a.dataLabel._pos = null, !c(h.style.width) && !c(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) && a.dataLabel.getBBox().width > l && (a.dataLabel.css({
                    ...
                    if (l) {
                        ...
                        for (W = 0; W < l; W++) {
                            ...
                            R = t = L.natural.y;
                            p && c(A.distributeBox) && ("undefined" === typeof A.distributeBox.pos ?
                                S = "hidden" : (I = A.distributeBox.size, R = F.radialDistributionY(A)));
                            ...
                            r(h.crop,
                                !0) && (B = G.getBBox().width, t = null, M - B < b && 1 === m ? (t = Math.round(B - M + b), y[3] = Math.max(t, y[3])) : M + B > f - b && 0 === m && (t = Math.round(M + B - f + b), y[1] = Math.max(t, y[1])), 0 > R - I / 2 ? y[0] = Math.max(Math.round(-R + I / 2), y[0]) : R + I / 2 > d && (y[2] = Math.max(Math.round(R + I / 2 - d), y[2])), G.sideOverflow = t)
                        }
                    }
            ...
            function y(a) {
                let c = this.center,
                    ...
                    b = e.minSize || 80,
                    f, d = null !== e.size;
                d || (null !== g[0] ? f = Math.max(c[2] - Math.max(a[1], a[3]), b) : (f = Math.max(c[2] - a[1] - a[3], b), c[0] += (a[3] - a[1]) / 2), null !== g[1] ? f = v(f, b, c[2] -
                    Math.max(a[0], a[2])) : (f = v(f, b, c[2] - a[0] - a[2]), c[1] += (a[0] - a[2]) / 2), f < c[2] ? (c[2] = f, c[3] = Math.min(e.thickness ? Math.max(0, f - 2 * e.thickness) : Math.max(0, l(e.innerSize || 0, f)), f), this.translate(c), this.drawDataLabels && this.drawDataLabels()) : d = !0);
                return d
            }
            const F = [],
                e = {
    ...
    M(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function(a, y) {
        ...
        a.prototype.hideOverlappingLabels = function(a) {
            ...
            for (h = 0; h < n; h++)
                for (g = (y = a[h]) && y.absoluteBox, l = h + 1; l < n; ++l) t = (q = a[l]) && q.absoluteBox, !g || !t || y === q || 0 === y.newOpacity ||
                    0 === q.newOpacity || "hidden" === y.visibility || "hidden" === q.visibility || t.x >= g.x + g.width || t.x + t.width <= g.x || t.y >= g.y + g.height || t.y + t.height <= g.y || ((y.labelrank < q.labelrank ? y : q).newOpacity = 0);
            a.forEach(function(a) {
                x(a, c) && (v = !0)
            });
    ...
    M(a, "Extensions/BorderRadius.js", [a["Core/Defaults.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(a, y, G,
        L, A, D) {
        const {
            defaultOptions: x
        } = a;
        ...
        if (-1 === L.symbolCustomAttribs.indexOf("borderRadius")) {
                ...
                for (h = a.length - 1; h--;) {
                    {
                        ...
                        if (m && g && g.params) {
                            ...
                            c ? (k.start = a + x, m[1] = h + w * Math.cos(a),
                                m[2] = l + w * Math.sin(a), q.splice(b + 1, 0, ["A", f, f, 0, 0, 1, h + d * Math.cos(k.start), l + d * Math.sin(k.start)])) : (k.end = e - x, g[6] = h + d * Math.cos(k.end), g[7] = l + d * Math.sin(k.end), q.splice(b + 1, 0, ["A", f, f, 0, 0, 1, h + w * Math.cos(e), l + w * Math.sin(e)]));
            ...
            A.prototype.symbols.roundedRect = function(a, c, h, l, e = {}) {
                ...
                l < d - t && (l = Math.sqrt(Math.pow(d, 2) - Math.pow(d - t - l,
                    2)), x[0] = v[0] = a + h - d + l, b[0] = Math.min(x[0], b[0]), f[0] = Math.max(v[0], f[0]), z[0] = A[0] = a + d - l, v[1] = z[1] = c);
                g.length = 0;
                ...
                if (this.options.borderRadius &&
                    ...
                    for (const l of this.points)
                        if ({
                            ...
                            var q = d,
                                e = f;
                            "stack" === a.scope && l.stackTotal && (q = r.translate(p ? 100 : l.stackTotal, !1, !0, !1, !0), e = r.translate(g.threshold || 0, !1, !0, !1, !0),
                                e = this.crispCol(0, Math.min(q, e), 0, Math.abs(q - e)), q = e.y, e = e.height);
    ...
    M(a, "masters/highcharts.src.js", [a["Core/Globals.js"], a["Core/Utilities.js"],
        ...
        y, G, L, A, D, C, z, t, v, c, n, r, l, h, q, g, w, J, F, e, m, u, p, H, b, f, d, k, M, N, E, S, T) {
        a.animate = A.animate;
