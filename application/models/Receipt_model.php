...
class Receipt_model extends CI_Model
{
  ...
  function __construct()
    ...
    public function get_receipt_list($sdate,$edate,$sodr)
    {
        ...
        $result  = $this->other_db->query("SELECT MASTER_SNO,TRANSDATE,AMOUNT,DESCRIPTION,COMPANYCODE,ADDED_USER,ADDED_TIME,VOUCHER_NO FROM VOUCHER_MASTER  WHERE COMPANYCODE='".$_SESSION['COMPANYCODE']."' $sdate $edate AND VOUCHER_TYPE='RECEIPT' $sodr")->result_array();
        save_query_in_log();
        $this->other_db->close();
        return $result;
    }
