...
class Loan_model extends CI_Model
{
  ...
  {
     $query = $this->db->query("SELECT l.BILLNO,c.COMPANYNAME,l.LOAN_TYPE,l.ENDATE,l.AMOUNT, i.PERIOD, l.INTERESTTYPE,l.WEIGHT,l.STONELESS,l.LESS,l.NETWEIGHT, l.MONTHS,l.LOANDAYS,l.ITEM_PHOTO,l.NOMINEE,l.RELATION,l.NOMINEE_ID, p.PID, p.NAME,p.ADDRESS1,p.ADDRESS2,p.PHONE,p.CITY,p.MEMBERSHIP_ID,p.MEMBERSHIP_POINTS,p.RATING,p.PHOTO,p.OTHER_PHOTO,l.LOAN_STATUS from LOANS l,PARTIES p,COMPANY c,INTERESTLIST i WHERE l.PID=p.PID and i.INTNAME=l.INTERESTTYPE and l.COMPANYCODE=c.COMPANYCODE and l.LOAN_STATUS>=1 and  l.BILLNO LIKE '".$search.'%'."'  ");
