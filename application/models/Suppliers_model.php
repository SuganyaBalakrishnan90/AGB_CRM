...
class Suppliers_model extends CI_Model
{
  ...
  function __construct()
    ...
    {
        $this->other_db->reconnect();
        $result  = $this->other_db->query("SELECT DISTINCT GROUP_NAME FROM ACC_LEDGERS WHERE GROUP_NAME='SUPPLIERS'" )->result_array();
        save_query_in_log();
        $this->other_db->close();
        return $result;
    }
    ...
    public function get_idtype_list()
    {
        ...
        $result = $this->db->query("SELECT * FROM IDTYPE")->result_array();
    ...
    {
        $this->other_db->reconnect();
        $result  = $this->other_db->query("DELETE FROM ACC_LEDGERS WHERE LEDGER_SNO = '".$sno."'");
        save_query_in_log();
        $this->other_db->close();
        return $result;
    }
