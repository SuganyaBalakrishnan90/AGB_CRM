...
****************************************************************/
class Realestate_purschase_model extends CI_Model
{
 ...
 public function get_pur_list($fdate,$tdate,$party_name,$pro_type,$ploat_type,$offset,$page_limit)
  ...
  public function get_pur_view($prop_pur_id)
    {
       
         $this->db->reconnect();
         $result  = $this->db->query("SELECT * FROM realestate_purchase WHERE id='".$prop_pur_id."' ")->row();
    ...
    public function get_por_view($prop_id)
    {
         ...
         $this->db->reconnect();
         $result  = $this->db->query("SELECT * FROM realestate_purchase WHERE id='".$prop_id."' AND property_status='New'  ")->row();
...
public function update_purchase_entry($data){
         $por_date = date("Y-m-d",strtotime($data['porp_date'])); 
 ...
 public function last_p_r_id_details()
  ...
  {
     $query = $this->db->query("SELECT * from PARTIES where NAME LIKE '".$search.'%'."' OR PHONE LIKE '".$search.'%'."'  ");
   ...
   public function get_fin_years_list()
    ...
    public function get_agent_list($search)
    {
        ...
        $result  = $this->other_db->query("SELECT * FROM ACC_LEDGERS  WHERE  LEDGER_NAME LIKE '".$search.'%'."'  AND GROUP_NAME='RE-AGENT' " )->result_array();
        save_query_in_log();
  ...
  public function prop_delete($uid)
    ...
    public function prop_receipt_delete($uid)
    {
        $this->db->reconnect(); 
       // AKS_PRD_MASTER set PRD_CUR_QTY='".$qtot."' where AKS_PRD_MID=". $prdd
        $result  = $this->db->query("UPDATE realestate_purchase_receipt SET status='N' WHERE property_id='".$uid."'");
        save_query_in_log();
        $this->db->close();
        return $result;
    }
