...
class Aks_stock_model extends CI_Model
{
  function __construct()
    ...
    public function get_prd_list()
    {
        ...
        $result = $this->db->query("SELECT PRD.AKS_PRD_MID,PRD.AKS_CAT_NAME as AKS_CAT_ID,PRD.AKS_PRD_NAME,PRD.AKS_PRD_WT,PRD.AKS_PRD_PRICE,PRD.AKS_PUR_PRICE,PRD.AKS_MIN_STK,PRD.AKS_MAX_STK,PRD.AKS_PRD_DETAIL,PRD.AKS_PRD_IMG,PRD.PRD_CUR_QTY,PRD.STATUS,PRDC.AKSCATEGORY_NAME from   AKS_PRD_MASTER  PRD ,AKSPRODUCT_CATEGORY  PRDC  WHERE PRD.AKS_CAT_NAME=PRDC.AKSCATEGORY_ID  ")->result_array();
        // print_r($result);
