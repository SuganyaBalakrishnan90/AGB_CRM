...
class Membership_model extends CI_Model
{
  function __construct()
    ...
    {
        $this->db->reconnect();
        $result  = $this->db->query("INSERT INTO MEMBERSHIP_CARD (MEMBERSHIP_NO,CARD_TYPE,POINTS,PID,ISSUE_DATE,EXP_DATE,CREATED_ON,CREATED_BY,STATUS)VALUES ('".$data['mem_card_no']."','".$data['mem_type']."','".$data['mem_add_points']."','".$data['first_name_id_hidden']."','".$data['issue_date']."','".$data['exp_date']."','".$data['created_on']."','".$data['added_user']."','Y')");
        save_query_in_log();
        $this->db->close(); 
        return $result;
    }
