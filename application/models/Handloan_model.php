...
public function  get_company_list()
 ...
 public function getUsers($search)
  ...
  public function get_hl_trans_key_value($lprefix)
    ...
    public function chit_trans_add($data)
    {
      if($data['scm_chit']=='1')
...
public function ac_cashsave($data)
   ...
   public function ac_memsave($data)
    {
     if($data['ac_mem_red_point']>0) {
    $ac_mem = $this->db->query("INSERT INTO payment_inward_outward
                                           ...
                                           VALUES(
                                            'Hl_receipts',
                                            '".$data['ac_mempay_mode']."',
                                            '".$data['ac_mem_red_point']."',
                                            '".$data['ac_mem_card_no']."',
                                            '',
                                            '".$data['ac_mem_red_detail']."',
                                            '".$data['ac_HandLoan_id']."',
                                             '".$data['party_ids']."','-','-','-','0','0','0'
                                            )");
             save_query_in_log();
   ...
   public function ac_chitsave($data)
    {
     if($data['ac_chit_red_amount']>0) {
...
public function mem_points($data)
    {
     if($data['ac_mem_red_point']>0) {
