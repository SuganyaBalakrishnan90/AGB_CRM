				...
				<div class="modal-content rounded">
          		...
          		<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="ccl_pending_edit">
						...
						<div class="row"> -->
							...
							<div class="col-lg-3">
								<input type="text" class="form-control form-control-lg1 form-control-solid" placeholder="Sales Amount" name="new_sales_amount" id="new_sales_amount" value="<?php echo $ccl_sale_list->curr_sales_amount; ?>">
