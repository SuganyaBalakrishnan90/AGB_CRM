						...
						<div id="kt_content_container" class="container-xxl">
							...
							<div class="row gy-5 g-xl-8">
					            ...
					            <?php } ?>					                       
											...
											<div class="menu-item px-3">
												<a href="#" id="pop_up_success1" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#success_modal"></a>
											</div>
												...
												<div class="modal-content rounded">
													<div class="swal2-icon swal2-success swal2-icon-show" style="display: flex;">
														...
														<div class="swal2-html-container" id="swal2-html-container" style="display: block;">
															<b><span id="success_msg"> <?php //echo $this->session->flashdata('g_success'); ?></span></b>
															</div>
										...
										<div class="card-body py-4">
												...
												<div class="col-lg-4">
													<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
														...
														<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
															<form action="<?php echo base_url();?>jewelsettlement" method="POST" >
															<div class="px-7 py-5" data-kt-user-table-filter="form">
																...
																<div class="mb-2">
																	...
																	<input type="text" class="form-control form-control-lg form-control-solid" name="loan_no_filter" id="loan_no_filter" value="<?php echo $loan_no_filter; ?>">
																</div>
																<div class="mb-2">
																	<label class="form-label fs-6 fw-semibold">Party</label>
																	<input type="text" class="form-control form-control-lg form-control-solid" name="pname_filter" id="pname_filter" value="<?php echo $pname_filter;?>">
																</div>
																<div class="mb-2">
																	<label class="form-label fs-6 fw-semibold">Jewel Type</label>
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" id="jtype_filter" name="jtype_filter" >	
																...
																<div class="mb-2">
																	...
																	<select class="form-select form-select-solid fw-semibold" data-control="select2" data-close-on-select="true" data-allow-clear="true" multiple="multiple" name="loan_status_filter" id="loan_status_filter">	
																...
																<div class="mb-2 fv-row" id="today_dt_loan_list" style="display:none;">
																	...
																	<div class="d-flex align-items-center">
																		...
																		<!--end::Svg Icon-->
																		<input class="form-control form-control-solid ps-12" name="today_date_fillter_loan_list" placeholder="Date" id="today_date_fillter_loan_list" value="<?php echo date("d-m-Y"); ?>" disabled />
																	</div>
																</div>
																...
																<div class="mb-2 fv-row" id="monthly_dt_loan_list" style="display:none;">
																	...
																	<div class="d-flex align-items-center">
																		...
																		<!--end::Svg Icon-->
																		<input class="form-control form-control-solid ps-12" name="monthly_date_fillter_loan_list" placeholder="Month" id="monthly_date_fillter_loan_list" value="<?php echo date("m-Y"); ?>" />
																	</div>
																</div>
											...
											<table class="table align-middle table-hover fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning1">
												...
												<tbody class="text-gray-600 fw-semibold">
													<?php 
													$i=1;
													foreach($js_list as $jlist) { ?>
													
													
													<tr class="<?php echo ($jlist['CHK_RETURNED']=='Y')?'bg-success':''; ?>">
														<td><?php echo $jlist['RETURNDATE'];?></td>
														<td class="ple1"><?php echo $jlist['COMPANYNAME'];?></td>
														<td class="ple1">
															<span><?php echo $jlist['BILLNO'];?></span>
															<?php 
															$res=$this->db->query("select COUNT(*) as count from PLEDGEINFO where BILLNO = '".$jlist['BILLNO']."' and STATUS='BANK' and REPLEDGE_SNO!=''")->row();
															if($res->count>0){
															?>
														...
														<td class="ple1">
															<?php 
																if($jlist['RATING']==3)
																{
																	...
																	echo '<span><i class="fa-solid fa-star fs-7" style="color:#50cd89;"></i> </span>';
																}
																else if($jlist['RATING']==2)
																{
																	// echo '<b><span class="badge badge-warning">AVERAGE</span></b>';
																	echo '<span><i class="fa-solid fa-star fs-7" style="color:#ffc700;"></i> </span>';
																}
																else if($jlist['RATING']==1)
																{
																	// echo '<b><span class="badge badge-danger">BAD</span></b>';
																	echo '<span><i class="fa-solid fa-star fs-7" style="color:red;"></i> </span>';
																}
																else
																{
																	echo '<span><i class="fa-solid fa-star fs-7" style="color:#d2d4dc;"></i> </span>';
																}
																?>
															<span class="align-items-center"><?php echo $jlist['NAME']; ?></span>
														</td>
														<td><?php echo $jlist['INTERESTTYPE']; ?></td>
														<td><?php echo $jlist['JEWEL_TYPE']; ?></td>
														<td><?php 
														$pl_cnt=$this->db->query("select count(*) as pl_count from PLEDGEINFO where BILLNO='".$jlist['BILLNO']."'")->row();
														echo $pl_cnt->pl_count;
														?></td>
														<td class="ple1"><?php echo $jlist['TOTALPAY']; ?></td>
														<td>
															<label class="col-form-label fw-semibold fs-7" name="" id="" >
															</label>
															<?php
																if($jlist['CLOSING_TYPE']=='CUSTOMER_CLOSE'){?>
																<span style="background-color:#ffdf6f;border-radius: 8px;padding: 5px 15px 5px 15px;">Customer Close</span>
															<?php
															}
															else if($jlist['CLOSING_TYPE']=='CUSTOMER_SALE'){ ?>
																<span style="background-color:#fbe2d5;border-radius: 8px;padding: 5px 15px 5px 15px;">Customer Sale</span>
															<?php } 
															else if($jlist['CLOSING_TYPE']=='MULTI_JEWEL'){?>
																<span style="background-color:#a3ff9b;border-radius: 8px;padding: 5px 15px 5px 15px;">Multi Jewel</span>
															<?php }
															else if($jlist['CLOSING_TYPE']=='COMPANY_CLOSE'){?>
																<span style="background-color:#b0dfff;border-radius: 8px;padding: 5px 15px 5px 15px;">Company Close</span>
															<?php 
														...
														<td>
															<span class="text-end">
																<?php if($jlist['CHK_RETURNED'] !='N'){ ?>
																<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" title="View">
															...
															<?php } ?>
															<?php 
																		$bno=str_replace('/', '_',  $jlist['BILLNO']);
																?>
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true" style="">
																	<?php 
																		if(($jlist['CLOSING_TYPE']=='CUSTOMER_CLOSE') || ($jlist['CLOSING_TYPE']=='MULTI_JEWEL')) 
																		{
																	 ?>
																	<div class="menu-item px-3">
																		
																		<a href="<?php echo base_url();?>jewelsettlement/jewel_settlement_add/<?php echo $bno;?>" target="_blank" class="menu-link px-3">Jewel Settlement</a>
																	</div>
																<?php }?>
																<?php 
																		if(($jlist['CLOSING_TYPE']!='CUSTOMER_CLOSE') && ($jlist['CLOSING_TYPE']!='MULTI_JEWEL')) 
																		{
																			if(($jlist['CLOSING_TYPE']=='COMPANY_CLOSE') && ($jlist['IS_LOCK_OUT']==0))
																			{
																	 ?>

																	<div class="menu-item px-3">
																		<a href="javascript:;" class="menu-link flex-stack px-3" onclick="return js_fn_lock_out('<?php echo $jlist['BILLNO'];?>')"><!-- data-bs-toggle="modal" data-bs-target="#kt_modal_verify_lockout"> -->Lock Out</a>
																	</div>
																<?php } ?>
																	<?php 
																			if(($jlist['CLOSING_TYPE']=='COMPANY_CLOSE' && $jlist['IS_LOCK_OUT']==1) || ($jlist['CLOSING_TYPE']=='CUSTOMER_SALE' && $jlist['IS_LOCK_OUT']==0)){
																			// if($jlist['IS_LOCK_OUT']==1) ?>
																	<div class="menu-item px-3">
																		<a href="javascript:;" class="menu-link flex-stack px-3" onclick="js_load_update_pledge('<?php echo $jlist['BILLNO'];?>');"><!-- data-bs-toggle="modal" data-bs-target="#kt_modal_update_pledge_items" --> Update Pledge Values</a>
																	</div>
																<?php } ?>
																	<!-- <div class="menu-item px-3">
																		<a href="javascript:;" class="menu-link flex-stack px-3" data-bs-toggle="modal" data-bs-target="#convert_old_gold">Sale</a>
																	</div> -->
																	<?php if($jlist['IS_LOCK_OUT']==2 ){ ?>
																		<div class="menu-item px-3">
																		<a href="javascript:;" class="menu-link flex-stack px-3" onclick="js_load_update_pledge('<?php echo $jlist['BILLNO'];?>');"><!-- data-bs-toggle="modal" data-bs-target="#kt_modal_update_pledge_items" --> Update Pledge Values</a>
																	</div>
																	<div class="menu-item px-3">
																		<a href="javascript:;" class="menu-link flex-stack px-3"  onclick="js_load_sale_value_request('<?php echo $jlist['BILLNO'];?>');">Sale Value for Pledges</a>
																	</div>
																<?php } ?>
																<?php } ?>
																</div>
											...
											<?php 
												$coun = ceil( $row_count/25);
												$c_page = isset($_GET['page']) ? $_GET['page'] : 1;
											?>
											<?php $paging_info = get_paging_info($row_count,25,$c_page); ?>
				...
				<div class="modal-dialog modal-m">
					...
					<div class="modal-content rounded">
						<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
							<div class="swal2-icon-content">&#x2713;</div></div>
							<div class="swal2-html-container" id="swal2-html-container" style="display: block;">
								<b><span id="lo_bill_no">MIP-405/21</span></b>
								<p class="mt-2">Are you sure you want to Lock Out?</p></div>
							<div class="d-flex flex-center flex-row-fluid pt-3">
								<button type="submit" class="btn btn-primary me-3"  id="lo_submit" >Yes</button>
								<button type="reset" class="btn btn-secondary" onclick="closeLockOutmodal();">No</button>
							</div><br><br>
					</div>
					<!--end::Modal content-->
		</div>
...
function js_load_sale_value_request(val)
{
		var baseurl= $("#baseurl").val();
		$.ajax({
				type: "POST",
				url: baseurl+'jewelsettlement/js_load_sale_value_request',
				async: false,
				type: "POST",
				data: "billno="+val,
				dataType: "html",
				...
				{
						$('#sale_to_ccl_list').empty().append(response);
						$('#sale_to_ccl_list').addClass('show');
						$('#sale_to_ccl_list').show();	
						$('.modal-backdrop').show();
				}
		});
...
function CloseSaletoCCLlistModal() {
	// $('#sale_to_ccl_list').empty().append(response);
						$('#sale_to_ccl_list').removeClass('show');
						$('#sale_to_ccl_list').hide();	
						$('.modal-backdrop').hide();
	
}
// function send_to_ccl_sale_request()
// {
		
// }

function js_load_update_pledge(val)
{
		var baseurl= $("#baseurl").val();
		//alert(val);
		$.ajax({
		type: "POST",
		url: baseurl+'jewelsettlement/load_pledge_to_update',
		async: false,
		type: "POST",
		data: "billno="+val,
		dataType: "html",
		success: function(response)
		{
		$('#kt_modal_update_pledge_items').empty().append(response);
		$('#kt_modal_update_pledge_items').addClass('show');
		$('#kt_modal_update_pledge_items').show();	
		$('.modal-backdrop').show();
		}
		});
}

function closeUpdatePledgeModal() 
{
		$('#kt_modal_update_pledge_items').addClass('hide');
		$('#kt_modal_update_pledge_items').hide();	
		$('.modal-backdrop').hide();
...
function calc_new_pledges(row_no)
{
		// var pl_pur_per = $('#pledge_pur_percent'+row_no).val();
		// var pl_wght = $('#pledge_weight'+row_no).val();
		// var pl_stn = $('#pledge_stone_weight'+row_no).val();
		// var pl_less = $('#pledge_less'+row_no).val();
		// var pl_net_wght = $('#pledge_net_weight'+row_no).val();
		...
		var tbl = document.getElementById("update_pledge_item");
		var tbodyRowCount = tbl.tBodies[0].rows.length;

		for(i=0;i<tbodyRowCount;i++)
		{
				tot_pur_per=parseFloat(tot_pur_per) + parseFloat($('#pledge_pur_percent'+i).val());
				tot_wght=parseFloat(tot_wght) + parseFloat($('#pledge_weight'+i).val());
				tot_stn_wght=parseFloat(tot_stn_wght) + parseFloat($('#pledge_stone_weight'+i).val());
				tot_less=parseFloat(tot_less) + parseFloat($('#pledge_less'+i).val());
				tot_net_wght=parseFloat(tot_net_wght) + parseFloat($('#pledge_net_weight'+i).val());
		}
	...
	<script type="text/javascript">
		function js_fn_lock_out(val)
		{
				...
				{
					// alert("Enter bill no");
					$('#err_msg').html('Could not Lock out Jewel');
				...
				else
				{
						$('#lo_bill_no').html(val);
						// $('#lo_submit').html(val);
						$('#lo_submit').attr('onclick',"update_loan_status('"+val+"')");
						// $('#kt_modal_verify_lockout').empty().append(response);
						$('#kt_modal_verify_lockout').addClass('show');
						$('#kt_modal_verify_lockout').show();
		...
		{
				$('#kt_modal_verify_lockout').removeClass('show');
				$('#kt_modal_verify_lockout').hide();
				$('.modal-backdrop').removeClass('show');
	   		$('.modal-backdrop').hide();
		}

		function update_loan_status(val)
		{
				var baseurl= $("#baseurl").val();
				var str=val.replace("/","_");
				$.ajax({
				type: "POST",
				url: baseurl+'jewelsettlement/upd_loan_sts',
				async: false,
				type: "POST",
				data: "billno="+val,
				dataType: "html",
					...
					// alert (s);
						if(s==1)
						{
				   		...
				   		// $('.modal-backdrop').hide();
							...
							$('#success_msg').html('<p>Lock out completed for No : '+val+'</p>');
							document.getElementById("pop_up_success1").click();
							// window.location.replace=baseurl+"jewelsettlement";
							location.reload();
					}
					else
					{	
				   		...
				   		// $('.modal-backdrop').hide();
							...
							$('#err_msg').html('<p> Lock Out not possible, Jewel not Locked In for Loan No : '+val+'</p>');
							document.getElementById("pop_up_success").click();
							// window.location.replace=baseurl+"jewelsettlement";
							location.reload();
					}
	...
	<script >
		...
		$(document).ready(function() 
		{
		        ...
		        $(".move_to").on("click", function () {
					...
					value=$(this).val();
					// alert(value);
		            $('#filter_form').attr('action', "<?php echo base_url(); ?>jewelsettlement?page="+value);
		            $("#filter_form").submit();
		            e.preventDefault();
		        });
		    });
