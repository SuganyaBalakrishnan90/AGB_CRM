										...
										<div class="card-body py-4">
											...
											<div class="tab-content" id="myTabContent">
												<div class="tab-pane fade show active" id="ccl_pending_list" role="tabpanel">
														...
														<table id="kt_datatable_ccl_pending_list_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable">
																...
																<tbody class="text-gray-600 fw-semibold">
																	<tr>
																		...
																		<td>
																			<span class="text-end">
																				<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_ccl_pending_list">
																	...
																	<tr>
																		...
																		<td>
																			<label class="col-form-label fw-semibold fs-7" id="dfn">
																				...
																				<a href="javascript:;" class="menu-link flex-stack align-items-center" data-bs-toggle="modal" data-bs-target="#kt_modal_description">
																					<i class="fas fa-info-circle fs-6" style="color:black;"></i>
																				</a>
																				<!-- <span id="c_nme">
																				</span> -->
																			</label>
																		...
																		<td>
																			<span class="text-end">
																				...
																				<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_ccl_pending_list">
													...
													<div class="row mt-13">
														<h2>Jewellery(Old Gold Purchase)</h2>
														<table id="kt_datatable_jewellery_accept_table" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable">
															<thead>
															   <tr class="text-start text-muted fw-bold fs-7 gs-0">
															   	<th class="min-w-50px">SNo</th>
															   	<th class="min-w-50px">Date</th>
															...
															<tbody class="text-gray-600 fw-semibold">
																<tr>
																	...
																	<td class="ple1">20000.00</td>
																	<td>
																		<label class="col-form-label fw-semibold fs-7" name="" id="" ><span style="background-color:#b0dfff;border-radius: 8px;padding: 5px 15px 5px 15px;">Requested</span>
																		</label>
																	</td>
																	<td>
																		<span class="text-end">
																			<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_jewellery_view_ccl_accept_list">
																				<i class="bi bi-eye-fill eyc"></i>
																			</a>
																		</span>
																	</td>
																...
																<tr>
																	...
																	<td>24/06/2023</td>
																	<td class="ple1">AGB - Main Branch Sayalkudi</td>
																	<td class="ple1">MIP-233/23</td>
																	<td class="ple1">
																		<span><i class="fa-solid fa-star fs-7" style="color:red;"></i></span>
																		<span class="align-items-center">Valavan</span>
																	</td>
																	<td>3</td>
																	<td class="ple1">25000.00</td>
																	<td>
															...
															<table id="kt_datatable_ccl_completed_list" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable">
																	...
																	<tbody class="text-gray-600 fw-semibold">
																		<tr>
																			...
																			<td>
																				<span class="text-end">
																					<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_ccl_completed_list">
																						<i class="bi bi-eye-fill eyc"></i>
																					</a>
																				</span>
																			</td>
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<label class="col-lg-12 col-form-label fw-bold fs-6">The Jewel Value is maximum 15,000.00</label>
						</div>
					</div>
					<!--end::Modal body-->
				</div>
