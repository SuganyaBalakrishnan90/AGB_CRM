								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
												<form method="POST" id="frm_js_submit" action="jewelsettlement/jewelsettelement_save" enctype="multipart/form-data" onsubmit=" return fsd_validation();" >
														<div class="row">
															<div class="col-lg-12">
																		...
																		<div class="row">
																			...
																			<div class="col-lg-6">
																				<div class="row">
																					...
																					&emsp;<span  name="r_address" id="r_address"><?php echo $party_details->DOORNO." ".$party_details->ADDRESS2."<br>".$party_details->AREA;?></span></label>
																					<label class="col-lg-12 col-form-label fw-bold fs-6">
											...
											<div id="mul_jwl" style="display: <?php echo ($loan_details->CLOSING_STATUS=='MULTI_JEWEL')?'block':'none'; ?>">
												...
												<div class="row">
													...
													<label class="col-lg-1 col-form-label fw-bold fs-6"><?php echo $new_loan_details->PERGRAMVALUE; ?></label>
													<label class="col-lg-1 col-form-label fw-semibold fs-6">SalesRate</label>
													<label class="col-lg-1 col-form-label fw-bold fs-6"><?php echo $new_loan_details->TOTALSALESRATE; ?></label>
												</div>
												<div class="row mt-4">
													<label class="col-form-label fw-bold fs-2">Verification Images</label>
													<div class="col-lg-6">
		...
		<div class="modal fade" id="kt_modal_pledge_items" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-xl">
          	...
          	<div class="row">
						...
						<div class="row">
							<label class="col-lg-1 col-form-label fw-semibold fs-6">Gram.Val</label>
							<label class="col-lg-1 col-form-label fw-bold fs-6"><?php echo $loan_details->PERGRAMVALUE;?></label>
							<label class="col-lg-1 col-form-label fw-semibold fs-6">SalesRate</label>
							<label class="col-lg-1 col-form-label fw-bold fs-6"><?php echo $loan_details->TOTALSALESRATE;?></label><!-- 
