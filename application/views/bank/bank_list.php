											...
											<tr>
												...
												<td>
													<label class="form-check form-switch form-check-custom form-check-solid">
															<input class="form-check-input" type="checkbox" id="activeunactive_<?php echo $i;?>"  name="activeunactive_<?php echo $i;?>" onchange="activeunactive('<?php echo $bank_settings['SNO']; ?>',<?php echo $i; ?>)" value=
															<?php 
												...
												<td>
													<span class="text-end">
													<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_view_bank" onclick="bank_view('<?php echo $bank_settings['SNO']; ?>')">
													...
													<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_bank" onclick="bank_delete('<?php echo $bank_settings['SNO']; ?>')">
