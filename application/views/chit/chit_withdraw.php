								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<!--end::Heading-->
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit_entry/withdraw_chit_id/<?php echo $chit->sno ?>" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
												...
												<div class="col-lg-4">
													<div class="row">
														...
														<label class="col-lg-12 col-form-label fw-bold fs-6" name="" id="">
															<i class="fa-solid fa-location-dot fs-6" aria-hidden="true" title="Address"></i>&nbsp;&nbsp;<span name="address" id="address"><?php echo $party->ADDRESS1; ?></span></label>
											...
											<div class="col-lg-8">
												...
												<div class="row">
													...
													<!-- Collection Type == Weekly start -->
														...
														<label class="col-lg-3 col-form-label fw-bold fs-5" id="collection_day"><?php echo $chit->collection_day; ?></label>
													...
													<?php } ?>
													<label class="col-lg-3 col-form-label fw-semibold fs-6">Available Amt</label>
													<label class="col-lg-3 col-form-label fw-bold fs-5"><?php echo $chit->ava_balance; ?></label>
													<input type="hidden" name="ava_balance" id="ava_balance" value="<?php echo $chit->ava_balance; ?>" >
														<?php if($chit->scheme_type=='3'){ ?>
													<label class="col-lg-3 col-form-label fw-semibold fs-6">Available Gold</label>
													<label class="col-lg-3 col-form-label fw-bold fs-5">
														<span></span>&emsp;
														<span>gms</span>
													</label>
