								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<!--end::Heading-->
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit_entry/deposit_chit" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
...
<?php //if($chit->collection_type=='2'){ ?>
												<div class="col-lg-2" id="collection_date_lab_div" style="display:none;">
												<label class="col-form-label fw-semibold fs-6">Collection Date &emsp;</label>	
												</div>
												<div class="col-lg-2" id="collection_date_val_div" style="display:none;">
												<label class="col-form-label fw-bold fs-5" id="collection_date"></label>
												</div>
												<div class="col-lg-2" id="collection_day_lab_div" style="display:none;">
												<label class="col-form-label fw-semibold fs-6">Collection Day &emsp;</label>
												</div>
												<div class="col-lg-2" id="collection_day_val_div" style="display:none;">
		...
		function deposit_chit_entry_validation(){
			...
			$("#chit_id").autocomplete({ 
					...
					if(suggestion.collection_type==1){
	                	...
	                	r='Weekly';	
						document.getElementById("collection_day_lab_div").style.display="block"
						document.getElementById("collection_day_val_div").style.display="block"
						document.getElementById("collection_date_lab_div").style.display="none"
						document.getElementById("collection_date_val_div").style.display="none"
						...
						$("#collection_day").html(day);
						// $("#collection_date_div").html(div);
	                }
	                else if(suggestion.collection_type==3){
	                	r='Monthly';	
						document.getElementById("collection_date_lab_div").style.display="block"
						document.getElementById("collection_date_val_div").style.display="block"
						document.getElementById("collection_day_lab_div").style.display="none"
						document.getElementById("collection_day_val_div").style.display="none"
						$("#collection_date").html(suggestion.collection_date);
						// $("#collection_day_div").html(div);
	                }
	                else{
	                	r='-';	
	                }
					...
					if(suggestion.scheme_ty==1){
	                	r='Selvamagal';	
					div='<div class="col-lg-6"><div class="row"><label class="col-lg-2 col-form-label fw-semibold fs-6">Cash</label><div class="col-lg-3"><input type="text" name="sm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount"><div class="fv-plugins-message-container invalid-feedback"></div></div></div></div>';
						gold_div='';
	                
				}
	                else if(suggestion.scheme_ty==2){
	                	r='Thangamagal';	
						div='<div class="col-lg-6"><div class="row"><label class="col-lg-2 col-form-label fw-semibold fs-6">Cash</label><div class="col-lg-3"><input type="text" name="tm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount"><div class="fv-plugins-message-container invalid-feedback"></div></div></div></div>';
						gold_div='';
					}
					...
					$.ajax({
					type: "POST",
					url: baseurl+'Chit_entry/get_photo',
					async: false,
					type: "POST",
					data: "id="+pid,
					dataType: "html",
