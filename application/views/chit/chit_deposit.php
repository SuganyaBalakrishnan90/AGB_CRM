	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<!--end::Heading-->
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit_entry/deposit_chit_id/<?php echo $chit->sno ?>" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
												...
												<div id="cash_sm_scheme">
													<div class="col-lg-6">
														<div class="row">
															...
															<div class="col-lg-3">
																<input type="text" name="sm_cash_box" id="sm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount">
												...
												<div id="cash_tm_scheme">
													<div class="col-lg-6">
														<div class="row">
															<label class="col-lg-2 col-form-label fw-semibold fs-6">Cash</label>
															<div class="col-lg-3">
																<input type="text" name="tm_cash_box" id="tm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
														</div>
													</div>
												...
												<div id="gold_tm_scheme">
													<div class="col-lg-12">
														<div class="row">
															...
															<div class="col-lg-2">
																<input type="text" name="tm_gold_box" id="tm_gold_box" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="cash_on()">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
											...
											<?php } ?>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cash_sl_tbox" style="display: none;">
														<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="cash_amt" id="cash_amt" onkeyup="amt_limit();" value="0">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="cheque_sl_amt_tbox" style="display: none;">
														<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Amount" name="bank_amt" id="cheque_amt" onkeyup="amt_limit();" value="0">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="rtgs_amt_tbox" style="display:none;">
														<input type="text" name="rtgs_amt" id="rtgs_amt" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="amt_limit();" value="0">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
												...
												<div class="row">
													...
													<div class="col-lg-2 fv-row fv-plugins-icon-container" id="upi_sl_amt_tbox" style="display: none;">
														<input type="text" class="form-control form-control-lg form-control-solid" value="0" placeholder="Amount" name="upi_amt" id="upi_amt" onkeyup="amt_limit();" value="0">
														<div class="fv-plugins-message-container invalid-feedback"></div>
													</div>
		...
		<script>
			function amt_limit()
			{
				...
				var bank = $('#bank_amt').val();
				var rtgs = $('#rtgs_amt').val();
				var upi = $('#upi_amt').val();
				var total = parseFloat(cash) + parseFloat(bank) + parseFloat(rtgs) + parseFloat(upi);
				alert(total);
			}
		</script>
