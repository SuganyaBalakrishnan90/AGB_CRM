						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Withdraw Chit
									<!--begin::Separator-->
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<!--begin::Table-->
											<!--end::Heading-->
											<form method="POST" autocomplete="off" action="<?php echo base_url(); ?>Chit_entry/withdraw_chit" enctype="multipart/form-data" onsubmit="return deposit_chit_entry_validation();">
											<div class="row">
												<div class="col-lg-6">
													<div class="row">
														...
														<label class="col-lg-2 col-form-label required fw-semibold fs-6">Chit ID</label>
														...
														<label class="col-lg-6 col-form-label fw-bold fs-6">
															...
															<span name="membership_card_no" id="membership_card_no"></span>&nbsp;
															<span id="red_cir"><i class="fas fa-times-circle fs-5" style="color:red;"></i></span>
															<span id="green_cir" style="display:none;"><i class="fas fa-check-circle fs-5" style="color:green;" ></i></span>
														</label>
														...
														<label class="col-lg-2 col-form-label fw-bold fs-6" name="" id=""><i class="fa-solid fa-coins fs-6" title="Points"></i>&nbsp;<span name="membership_card_points" id="membership_card_points" ></span></label>
													</div>
													<div class="row">
														<div class="col-lg-6">
														</div>
														<div class="col-lg-6" id="verify_btn" style="display:none;">
												...
												<div class="col-lg-2">
													...
													<div class="image-input image-input-outline" data-kt-image-input="true">
														...
														<div class="image-input-wrapper w-125px h-125px" style="background-image: url(assets/images/sample.jpg)" id="party_photo" name="party_photo">
														</div>
												...
												<div class="row">
														...
														<label class="col-lg-4 col-form-label fw-bold fs-5" name="scheme_type" id="scheme_type"><?php //if( $chit->scheme_type==1){ echo "Selvamagal"; }elseif($chit->scheme_type==2){ echo "Thangamagal-Cash"; }else{ echo "Thangamagal-Gold"; } ?></label>
														<!-- <div class="col-lg-6">
															<div class="d-flex justify-content-end">
																<button class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_verify_membership_card">Verify</button>
															</div>
...
<?php //if($chit->collection_type=='2'){ ?>
												...
												<!--<div class="col-lg-4">
													<label class="col-form-label fw-semibold fs-6">Collection Day &emsp;</label>
													<label class="col-form-label fw-bold fs-5" id="collection_day"></label>
												</div>-->
...
<?php // } ?><?php // if($chit->collection_type=='3'){ ?>
												...
												<!--<div class="col-lg-4">
													<label class="col-form-label fw-semibold fs-6">Collection Date &emsp;</label>
													<label class="col-form-label fw-bold fs-5" id="collection_date"></label>
												</div>-->
												...
												<label class="col-lg-1 col-form-label fw-bold fs-5" name="ava_amount" id="ava_amount" ><?php //echo $chit->ava_balance; ?></label>
	...
	<div id="ava_gold">
											...
											<?php // if($chit->scheme_type=='1'){ ?>
												...
												<!--<div id="cash_sm_scheme">
													<div class="col-lg-6">
														<div class="row">
															<label class="col-lg-2 col-form-label fw-semibold fs-6">Cash1</label>
															<div class="col-lg-3">
																<input type="text" name="sm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount">
												...
												<!--<div id="cash_tm_scheme">
													<div class="col-lg-6">
														<div class="row">
															<label class="col-lg-2 col-form-label fw-semibold fs-6">Cash1</label>
															<div class="col-lg-3">
																<input type="text" name="tm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
														</div>
													</div>
											...
											<!--	<div id="gold_tm_scheme">
													<div class="col-lg-12">
														<div class="row">
															<label class="col-lg-1 col-form-label fw-semibold fs-6">Cash1</label>
															<div class="col-lg-2">
																<input type="text" name="tm_gold_box" class="form-control form-control-lg form-control-solid" placeholder="Amount">
																<div class="fv-plugins-message-container invalid-feedback"></div>
															</div>
											...
											<?php  // } ?>
												...
												<div class="row">
													<label class="col-lg-1 col-form-label fw-semibold fs-6" id="cash_sl_label" style="display: none;">Cash1</label>
											...
											<div class="d-flex justify-content-end mt-4">
												...
												<button type="submit" class="btn btn-primary" id="save_changes_add_product">Withdraw Chit</button>
											</div>
											<!--end::Actions-->
										</div>
											<!--end::Table-->
		...
		function deposit_chit_entry_validation(){
			...
			$("#chit_id").autocomplete({ 
					...
					if(suggestion.scheme_ty==3){

						
						$('#kt_modal_chit_error').modal('show');
						//alert('This chit could not withdraw');
					}
					else {  $("#chit_id").val(suggestion.chit_id);   
					...
					if(suggestion.collection_type==1){
	                	...
	                	r='Weekly';	
						div='<label class="col-form-label fw-semibold fs-6">Collection Day &emsp;</label><label class="col-form-label fw-bold fs-5" id="collection_day"></label>';
					...
					if(suggestion.scheme_ty==1){
	                	r='Selvamagal';	
					div='<div class="col-lg-6"><div class="row"><label class="col-lg-2 col-form-label fw-semibold fs-6">Cash</label><div class="col-lg-3"><input type="text" oninput="cash_wd()" name="sm_cash_box" id="sm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount"><div class="fv-plugins-message-container invalid-feedback"></div></div></div></div>';
						gold_div='';
	                
				}
	                else if(suggestion.scheme_ty==2){
	                	r='Thangamagal Cash';	
						div='<div class="col-lg-6"><div class="row"><label class="col-lg-2 col-form-label fw-semibold fs-6">Cash</label><div class="col-lg-3"><input type="text" oninput="cash_wd()" name="tm_cash_box" id="tm_cash_box" class="form-control form-control-lg form-control-solid" placeholder="Amount"><div class="fv-plugins-message-container invalid-feedback"></div></div></div></div>';
						gold_div='';
					}
	                else if(suggestion.scheme_ty==3){
	                	r='Thangamagal Gold';	
						div='<div class="col-lg-12"><div class="row"><label class="col-lg-1 col-form-label fw-semibold fs-6">Cash</label><div class="col-lg-2"><input type="text" oninput="cash_wd()" name="tm_gold_box" id="tm_gold_box" class="form-control form-control-lg form-control-solid" placeholder="Amount" onkeyup="cash_on()"><div class="fv-plugins-message-container invalid-feedback"></div></div><label class="col-lg-2 col-form-label fw-semibold fs-6">Net Weight(gms)</label><label class="col-lg-2 col-form-label fw-bold fs-5" id="net_gm_lab"></label></div></div>';
						gold_div='';
						//    gold_div='<label class="col-lg-2 col-form-label fw-semibold fs-6">Available Gold</label><label class="col-lg-2 col-form-label fw-bold fs-5"><span></span>&emsp;<span>gms</span></label>';
					}
	                else{
	                	r='-';	
	                }
					...
					{
						// alert(1)
						document.getElementById("green_cir").style.display = "inline";
					...
					else
					{
						...
						document.getElementById("red_cir").style.display = "inline";
					}
				...
				var pid = suggestion.party_id;
					$.ajax({
					type: "POST",
					url: baseurl+'Chit_entry/get_photo2',
					async: false,
					type: "POST",
					data: "id="+pid,
					dataType: "html",
		...
		<script>
			$(document).on('input', "#sm_cash_box", function () {
				var ava = $("#ava_balance").val();
				// alert(ava)
				var sm_c = $("#sm_cash_box").val();
				// alert(sm_c)
				if (parseInt(ava) < parseInt(sm_c)) 
				{
		...
		<script>
			$(document).on('input', "#tm_cash_box", function () {
				var ava = $("#ava_balance").val();
				// alert(ava)
				var tm_c = $("#tm_cash_box").val();
				// alert(sm_c)
				if (parseInt(ava) < parseInt(tm_c)) 
				{
					alert("Invalid Input Amount");
					$("#tm_cash_box").val('0');
				}
		...
		<script>
			$(document).on('input', "#tm_gold_box", function () {
				var ava = $("#ava_balance").val();
				// alert(ava)
				var tm_g = $("#tm_gold_box").val();
				// alert(sm_c)
				if (parseInt(ava) < parseInt(tm_g)) 
				{
					alert("Invalid Input Amount");
					$("#tm_gold_box").val('0');
				}
