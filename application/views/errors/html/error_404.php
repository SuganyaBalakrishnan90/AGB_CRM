...
$ci->load->helper('common_helper');
 	...
 	$p_title = isset($g_settings->product_title) ? $g_settings->product_title : 'Bible Coaching Institute';
...
<?php $baseUrl=base_url();?>
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid  m-error-3" style="background-image: url(<?php echo $baseUrl;?>assets/app/media/img//error/bg3.jpg);">
				<div class="m-error_container">
					...
					<span class="m-error_number">
						<h1 style="color: #2d664b;margin-top: 1.6rem;">404</h1>
					</span>
					<p class="m-error_title m--font-light" style="color: #2d664b!important;">
