											 ...
											 <div class="col-lg-8">
												<div class="row">
													...
													<div class="col-lg-4">
														...
														<div class="text-center">
															<label class="text-success fs-2 fw-bold"><?php echo $prd_count->count; ?></label>
														</div>
													</div>
													<!-- <div class="col-lg-4">
														<div class="text-center">
											...
											<div class="col-lg-4">
												...
												<div class="d-flex justify-content-end"
													...
													<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
														...
														<form method="POST" action="<?php echo base_url(); ?>aksproduct_master">
															<!-- <form name="" id="" method="POST" action="<?php //echo base_url(); ?>" enctype="multipart/form-data" onsubmit="return();"> -->
															<div class="mb-2">
													        ...
													        <!-- <?php// if($category_name==$category_list['AKSCATEGORY_NAME']){ echo "selected"; } ?> -->
													        <div class="d-flex justify-content-end">
															...
															<!-- <div class="mb-2">
																...
																<select class="form-select form-select-solid" name="" id="" data-control="select2" data-hide-search="true">	
																	...
																	<optgroup label="jaggery">
																		<option value="all">All</option>
																		<option value="1">New Palm Jaggery</option>
																		<option value="2">Old Palm Jaggery</option>
																		<option value="3">Dry Ginger Palm Jaggery</option>
																		<option value="4">Baby Ginger Palm Jaggery </option>
																		<option>Adult Ginger Palm Jaggery </option>
																		<option>Aayurvedic Palm Jaggery </option>
																		<option>Sukku Blocks</option>
																	</optgroup>
																	<optgroup label="Palm candy">
																		<option value="all">All</option>
																		<option value="1">First Quality Palm Candy</option>
																		<option value="2">Second Quality Palm Candy</option>
																		<option value="3">Pannai karkandu</option>
																		<option value="4">Juicy Palm Candy</option>
																	</optgroup>
																	<optgroup label="Powders">
																		<option value="all">All</option>
																		<option value="1">Karuppati Powder</option>
																		<option value="2">Sukku karuppati Powder</option>
																		<option value="3">karuppati Amuthu</option>
																		<option value="4">Baby Snack Powder</option>
																		<option value="5">Baby Snack Nuts Powder</option>
																		<option value="6">Karuppati Puttu Powder</option>
																	</optgroup>
																	<optgroup label="Syrup">
																		<option value="all">All</option>
																		<option value="1">Karuppati Syrup</option>
												     				</optgroup>	
												     				<optgroup label="Kizhangu">
																		<option value="all">All</option>
																		<option value="1">Panng kizhangu</option>
												     				</optgroup>
												     				<optgroup label="Combos">
																		<option value="all">All</option>
																		<option value="1">Gift Combo Pack</option>
																		<option value="1">Gift Combo Pack Max</option>
																		<option value="1">Sample Pack </option>
												     				</optgroup>	
													            </select>
															</div> -->
															   </form>
												...
												<?php if(isset($_SESSION['Karupatti_productAdd'])){ if($_SESSION['Karupatti_productAdd']==1){?>

												  <a href="<?php echo base_url();?>aksproduct_master/aksaddproduct" target="_blank"> 
											...
											<table id="" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable no-footer">
												<thead>
												  <tr class="text-start text-muted fw-bold fs-7 gs-0">
														...
														<th class="min-w-50px">Min Stock</th>
														<th class="min-w-50px">Max Stock</th>
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<tr>
														<td><?php echo $i+1; ?></td>
															...
															<td><?php echo $plist['AKSCATEGORY_NAME'];?> 
														...
														<?php $image_url =  base_url().'assets/images/aks_product_image/'. $plist['AKS_PRD_IMG']; 
	                                                       ...
	                                                       $plist['AKS_PRD_IMG'];  ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-fslightbox="lightbox-basic<?php echo $i; ?>" data-bs-toggle="modal"  onclick="image_view('<?php echo $plist['AKS_PRD_IMG']; ?>')">
												            	    ...
												            	    <div class="image-input" data-kt-image-input="true">
																	  <div class="image-input-wrapper w-40px h-40px me-3" style="background-image: url(<?php echo base_url() ?>assets/images/aks_product_image/<?php echo $plist['AKS_PRD_IMG']; ?>)">
																	  </div>
																	 </div>
															</a>
 	                                                        <?php 
														...
														<td><?php echo $plist['HSN_CODE'];?></td>
														<td><?php echo $plist['AKS_PRD_WT'];?></td>
														<td><?php echo $plist['AKS_PRD_PRICE'];?></td>
														<td><?php echo $plist['AKS_PUR_PRICE'];?></td>
														<td><?php echo $plist['AKS_MIN_STK'];?></td>
														<td><?php echo $plist['AKS_MAX_STK'];?></td>
														<td><?php echo $plist['AKS_PRD_DETAIL'];?></td>
														<!--begin::Action=-->
														<td>
																<span class="text-end">
																	<!-- <?php //echo base_url();?>aksproduct_master/edit_prd/<?php// echo $plist['AKS_PRD_MID'];?> -->
																	<a href="<?php echo base_url();?>aksproduct_master/edit_prd/<?php echo $plist['AKS_PRD_MID'];?>"  target="_blank"
																	class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="Edit Product">
																	<!-- id="prd_edit_id_hidden" onclick="prd_edit()" -->
																	<!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
																	<i class="fa-solid fa-file-pen eyc fs-4" ></i>	
																	<!--end::Svg Icon-->
																    </a>
																    <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_aks_products" 
	...
	<!--end::Modal - delete Products-->
		...
		$(document).ready(function() {
			...
			$(".move_to").on("click", function () {
				value=$(this).val();
				// alert(value);
				$('#filter_form').attr('action', "<?php echo base_url(); ?>Aksproduct_master?page="+value);
				$("#filter_form").submit();
				e.preventDefault();
			});
		});
		...
		<script>
			...
			$.ajax({
			type: "POST",
			url: baseurl+'aksproduct_master/prd_delete',
			async: false,
			type: "POST",
			data: "id="+val,
			dataType: "html",
			...
			$.ajax({
			type: "POST",
			url: baseurl+'aksproduct_master/delete',
			async: false,
			data:"field="+val,
			success: function(response)
			{
			window.location.href = baseurl+'aksproduct_master';
			}
			});
			}
