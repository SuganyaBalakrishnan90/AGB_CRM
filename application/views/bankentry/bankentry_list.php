<?php $this->load->view("common");?>
	...
	<body data-kt-name="metronic" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed">
						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Bankentry List
									<!--begin::Separator-->
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
				                        ...
				                        <?php } ?>
										<form action="<?php echo base_url();?>bankentry" method="post">
											...
											<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning">
												...
												<thead>
													...
													<tr class="text-start text-muted fw-bold fs-7 gs-0">
														...
														<th class="min-w-125px">Paid From</th>
												...
												<tbody class="text-gray-600 fw-semibold">
													<!--begin::Table row-->
													<?php $i=1; foreach($bankentry_list as $dlist){
														$pledger = $this->Bankentry_model->get_ledger_details_by_voucher_master_no($dlist['MASTER_SNO']);
														...
														$pbyledger = $this->Bankentry_model->get_paidby_ledger_details_by_voucher_master_no($dlist['MASTER_SNO']);
													...
													<tr>
														...
														<td>
															<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_editbankentry" onclick="bankentry_edit('<?php echo $dlist['MASTER_SNO'];?>')">
																			...
																			<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_bankentry" onclick="bankentry_delete('<?php echo $dlist['MASTER_SNO'];?>')">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-7 text-center">
							<h1>Bank Entry [Bank Deposits and Withdrawls]</h1>
						</div>
						<!--end::Heading-->
						<form id="general_validate" style="width: 100%;" method="POST" action="<?php echo base_url(); ?>bankentry/bankentry_save" enctype="multipart/form-data" onsubmit="return bankentry_validation();">
								...
								<div class="col-lg-8">
									<div class="row">
										...
										<div class="col-lg-3 fv-row">
											<div class="d-flex align-items-center">
												<input type="date" class="form-control form-control-solid" name="add_date_bankentrys" placeholder="Select Date" id="add_date_bankentrys" />
											</div>
											<div class="fv-plugins-message-container invalid-feedback" id="add_date_bankentrys_err"></div>
										</div>
								...
								<div class="col-lg-12">
									<div id="kt_docs_repeater_basic_add">
										<div class="form-group">
											<div id="mcontent10">
												<div class="row" id="mid0">
													<label class="col-lg-2 col-form-label fw-semibold fs-6">Paid From</label>
													<div class="col-lg-3 fv-row">
													...
													<div class="col-lg-3 fv-row">
														<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter Amount" name="add_amt_bankentrys" id="add_amt_bankentrys0" style="font-size: 17px !important;font-weight: 600 !important;" onkeyup="getBankentryAmount(0)" onkeypress="return isNumberKey(event,this);"/>
														<div class="fv-plugins-message-container invalid-feedback" id="add_amt_bankentrys_err0"></div>
													</div>
													<!-- <div class="col-lg-2 fv-row">
										...
										<!-- <div class="col-lg-2 form-group fv-row">
											<a href="javascript:;" onclick="add_bankentry()" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2">
											Add</a>
										</div> -->
									</div>
							...
							<div class="row">
								<label class="col-lg-2 col-form-label required fw-semibold fs-6">Received In</label>
								<div class="col-lg-3 fv-row">
								...
								<div class="col-lg-3 fv-row">
									<input type="text" class="form-control mb-2 mb-md-0" id="add_tota_bankentrys" name="add_tota_bankentrys" style="font-size: 17px !important;font-weight: 600 !important;" readonly/>
								</div>
							...
							<div class="row">
								...
								<div class="col-lg-2">
									<div class="d-flex flex-center flex-row-fluid pt-2">
										<button type="submit" class="btn btn-primary" id="save_changes_add_bankentrys">Save Changes</button>
									</div>
								</div> -->
							</div>
		...
		<!--begin::Modal - edit company-->
		<div class="modal fade" id="kt_modal_editbankentry" tabindex="-1" aria-hidden="true">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-13 text-center">
							<h1 class="mb-3">Bankentry Details</h1>
						</div>
						<!--end::Heading-->
						<div class="row mb-6">
							<!--begin::Label-->
							...
							<div class="row mb-6">
								<!--begin::Label-->
												...
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Bankentry Name" Value="Accounts" disabled>
													<div class="fv-plugins-message-container invalid-feedback"></div>
												</div>
												<!--end::Col-->	
							</div>
		...
		<div class="modal fade" id="kt_modal_delete_bankentry" tabindex="-1" aria-hidden="true">
...
var title = $('title').text() + ' | ' + 'Bankentry';
...
function bankentry_validation()
{
    var err = 0;
    var detail_sno = $('#detail_sno').val();
    var paid_account_led_id = $('#paid_account_led_id').val();
    var add_date_bankentrys = $('#add_date_bankentrys').val();

    if(add_date_bankentrys.trim()==''){
        $('#add_date_bankentrys_err').html('Date is required!');
        err++;
    }else{
        $('#add_date_bankentrys_err').html('');
    }
...
$("div[id^='mid']").each(function(){
  ...
  var add_amt_bankentrys=$('#add_amt_bankentrys'+res).val();
     ...
     if(bav==0)  
  {
    if(account_led_id==''){
      ...
      if(add_amt_bankentrys==''){
        $('#add_amt_bankentrys_err'+res).html('Amount is required!');
        err++;
      }else{
        $('#add_amt_bankentrys_err'+res).html('');
      }
  }
  else
  {
    if(account_led_id!='' && add_amt_bankentrys==''){
        $('#add_amt_bankentrys_err'+res).html('Amount is required!');
        err++;
      }else{
        $('#add_amt_bankentrys_err'+res).html('');
...
function ledger_autocomplete(i)
{
	...
	$("#account_led_name"+i).autocomplete({ 
            valueKey:'title',
            source:[{
            url: base+'bankentry/get_bankentry_ledger?type=PRO_MANA&query=%QUERY%&showparty='+showparty,
            type:'remote',
            ajax:{
...
function paid_ledger_autocomplete()
{
	$("#paid_account_led_name").autocomplete({ 
            valueKey:'title',
            source:[{
            url: base+'bankentry/get_bankentry_paid_ledger?type=PRO_MANA&query=%QUERY%',
            type:'remote',
            ajax:{
...
function getBankentryAmount(i)
{
	var gamt = 0;
    $("input[id^='account_led_id']").each(function(){
        var id = this.id;
        var res = id.substring(14);
        var amt = $('#add_amt_bankentrys'+res).val();
        if(amt=='')
        {
        	amt=0;
        }
...
function bankentry_edit_validation()
{
    var err = 0;
    var detail_sno_edit = $('#detail_sno_edit').val();
    var paid_account_led_id_edit = $('#paid_account_led_id_edit').val();
    var add_date_bankentrys_edit = $('#add_date_bankentrys_edit').val();

    if(add_date_bankentrys_edit.trim()==''){
        $('#add_date_bankentrys_edit_err').html('Date is required!');
        err++;
    }else{
        $('#add_date_bankentrys_edit_err').html('');
    }
...
$("div[id^='mid_edit']").each(function(){
  ...
  var add_amt_bankentrys_edit=$('#add_amt_bankentrys_edit'+res).val();
     ...
     if(bav==0)  
  {
    if(account_led_id_edit==''){
      ...
      if(add_amt_bankentrys_edit==''){
        $('#add_amt_bankentrys_edit_err'+res).html('Amount is required!');
        err++;
      }else{
        $('#add_amt_bankentrys_edit_err'+res).html('');
      }
  }
  else
  {
    if(account_led_id_edit!='' && add_amt_bankentrys_edit==''){
        $('#add_amt_bankentrys_edit_err'+res).html('Amount is required!');
        err++;
      }else{
        $('#add_amt_bankentrys_edit_err'+res).html('');
...
function getBankentryAmountEdit(i)
{
	var gamt = 0;
    $("input[id^='account_led_id_edit']").each(function(){
        var id = this.id;
        var res = id.substring(19);
        var amt = $('#add_amt_bankentrys_edit'+res).val();
        if(amt=='')
        {
        	amt=0;
        }
...
function delete_bankentry_edit(i)
{
	$('#mid_edit'+i).remove();
...
function bankentry_edit(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'bankentry/bankentry_edit',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
...
{
$('#kt_modal_editbankentry').empty().append(response);
$('#kt_modal_editbankentry').addClass('show');
...
{
	var baseurl= $("#baseurl").val();
	$('#kt_modal_editbankentry').removeClass('show');
	//$("#kt_modal_update_role").css("display", "none");
	$('.modal-backdrop').removeClass('show');
	window.location.href = baseurl+'bankentry';
}

function bankentry_delete(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'bankentry/bankentry_delete',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
success: function(response)
{
$('#kt_modal_delete_bankentry').empty().append(response);
$('#kt_modal_delete_bankentry').addClass('show');
//$("#kt_modal_delete_role").css("display", "block");
}
});
}

function removeBankentry(val)
{ 
var baseurl= $("#baseurl").val();
$.ajax({
type: "POST",
url: baseurl+'bankentry/delete',
async: false,
data:"field="+val,
success: function(response)
{
...
{
	var baseurl= $("#baseurl").val();
	$('#kt_modal_delete_bankentry').removeClass('show');
	$('.modal-backdrop').removeClass('show');
	window.location.href = baseurl+'bankentry';
}
