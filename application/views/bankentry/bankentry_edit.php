				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-7 text-center">
							<h1>Update Bank Entry [Bank Deposits and Withdrawls]</h1>
						</div>
						<!--end::Heading-->
						<form id="general_validate" style="width: 100%;" method="POST" action="<?php echo base_url(); ?>bankentry/bankentry_update" enctype="multipart/form-data" onsubmit="return bankentry_edit_validation();">
									...
									<div class="row">
										...
										<div class="col-lg-3 fv-row">
											<div class="d-flex align-items-center">
												<input type="date" class="form-control form-control-solid" name="add_date_bankentrys" placeholder="Select Date" id="add_date_bankentrys_edit" value="<?php echo $voucher_master_details->TRANSDATE;?>" />
											</div>
											<div class="fv-plugins-message-container invalid-feedback" id="add_date_bankentrys_edit_err"></div>
										</div>
								...
								<div class="col-lg-12">
									<div id="kt_docs_repeater_basic_add">
										<div class="form-group">
											<div id="mcontent_edit10">
												...
												<div class="row" id="mid_edit<?php echo $i;?>">
													...
													<div class="col-lg-3 fv-row">
														<input type="text" class="form-control mb-2 mb-md-0" placeholder="Enter Amount" name="add_amt_bankentrys" id="add_amt_bankentrys_edit<?php echo $i;?>" style="font-size: 17px !important;font-weight: 600 !important;" onkeyup="getReceiptAmountEdit(<?php echo $i;?>)" onkeypress="return isNumberKey(event,this);" value="<?php echo $vdet['CREDIT'];?>"/>
														<div class="fv-plugins-message-container invalid-feedback" id="add_amt_bankentrys_edit_err<?php echo $i;?>"></div>
													</div>
												</div>
												<?php $i++;}
												else{
										...
										<!-- <div class="col-lg-2 form-group fv-row">
											<a href="javascript:;" onclick="add_bankentry_edit()" class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-2">
											Add</a>
										</div> -->
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 fv-row">
									<input type="text" class="form-control mb-2 mb-md-0" id="add_tota_bankentrys_edit" name="add_tota_bankentrys" style="font-size: 17px !important;font-weight: 600 !important;" value="<?php echo $voucher_master_details->AMOUNT;?>" readonly/>
								</div>
