						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Area List
									<!--begin::Separator-->
													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														...
														<form id="kt_modal_export_users_form" class="form" action="#">
															...
															<div class="fv-row mb-10">
																<!--begin::Label-->
																<label class="fs-6 fw-semibold form-label mb-2">Select Area:</label>
																<!--end::Label-->
																<!--begin::Input-->
																<select name="role" data-control="select2" data-placeholder="Select Company" data-hide-search="true" class="form-select form-select-solid fw-bold">
																	<option></option>
																	<option value="Area Details">Area Details</option>
									...
									<table class="table align-middle table-row-dashed table-striped table-hover fs-6 gy-1 gs-2" id="kt_datatable_dom_positioning">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px" style="width: 30%;">Zone Name</th>
												<th class="min-w-125px" style="width: 30%;" >Area Name</th>
										...
										<tbody class="text-gray-600 fw-semibold">
											<!--begin::Table row-->
											<?php $i=1; foreach($area_list as $dlist){?>
											<tr>
												<td><?php echo $dlist['ZONENAME'];?></td>
												<td><?php echo $dlist['AREANAME'];?></td>
												<!--begin::Action=-->
												<td>
													<span class="text-end">
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_editdept" onclick="area_edit('<?php echo $dlist['SNO'];?>')">
													...
													<a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_area" onclick="area_delete('<?php echo $dlist['SNO'];?>')">
		...
		<div class="modal fade" id="kt_modal_adddept" tabindex="-1" aria-hidden="true">
			...
			<div class="modal-dialog modal-m">
				...
				<div class="modal-content rounded">
					...
					<!--end::Modal header-->
					<!--begin::Modal body-->
					<form name="area_add_form" id="area_add_form" method="POST" action="<?php echo base_url(); ?>area/area_save" enctype="multipart/form-data" onsubmit="return area_validation();">
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							<!--begin::Heading-->
							<div class="mb-13 text-center">
								<h1 class="mb-3">New Area</h1>
							</div>
								<div class="row mb-6">
									<!--begin::Label-->
													...
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<select class="form-control" id="zone_id" name="zone_id">
															...
															<option value="<?php echo $zlist['SNO'];?>"><?php echo $zlist['ZONENAME'];?></option>
															<?php }?>
														</select>
														<div class="fv-plugins-message-container invalid-feedback" id="zone_id_err"></div>
													</div>
													<!--end::Col-->	
								</div>
								<div class="row mb-6">
									<!--begin::Label-->
													...
													<!--begin::Col-->
													<div class="col-lg-8 fv-row fv-plugins-icon-container">
														<input type="text" id="area" name="area" class="form-control form-control-lg form-control-solid" placeholder="Area Name" onkeyup="area_unique(this.value);">
...
<div class="modal fade" id="kt_modal_viewdept" tabindex="-1" aria-hidden="true">
						...
						<div class="row mb-6">
							...
							<div class="row mb-6">
								<!--begin::Label-->
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Area Name" Value="Accounts" disabled>
		...
		<!--End::View Company-->
		<!--begin::Modal - delete area-->
		<div class="modal fade" id="kt_modal_delete_area" tabindex="-1" aria-hidden="true">
			
		</div>
		<!--end::Modal - delete area-->
		<input type="hidden" id="baseurl" value="<?php echo base_url();?>">
		<?php $this->load->view("script");?>
		<script>

var title = $('title').text() + ' | ' + 'Area';
    $(document).attr("title", title);

function area_edit(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'area/area_edit',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
...
function closeEditModal()
{
	...
	window.location.href = baseurl+'area';
}


var berr=0;
function area_unique(val)
{
	var baseurl= $("#baseurl").val();
	$.ajax({
		type:"POST",
		url:baseurl+'area/area_unique',
		data:{'value':val},
		cache: false,
		dataType: "html",
			...
			if(result>0)
			{
				$('#area_err').html('Area already exist!');
				berr=1;
			}
			else
			{
...
var berre=0;
function area_unique_edit(val,dcid)
{
	var baseurl= $("#baseurl").val();
	$.ajax({
		type:"POST",
		url:baseurl+'area/area_unique_edit',
		...
		dataType: "html",
			...
			if(result>0)
			{
				$('#area_edit_err').html('Area already exist!');
				berre=1;
			}
			else
			{
...
function area_edit_validation()
{
	...
	if(zone_id.trim()==''){
        $('#zone_id_edit_err').html('Choose Zone!');
        err++;
    }else{
    ...
    if(area.trim()==''){
        $('#area_edit_err').html('Enter Area Name!');
        erre++;
    }else{
        //$('#area_err').html('');
        if(berre>0)
...
function area_delete(val){
var baseurl= $("#baseurl").val();
//alert(val);
$.ajax({
type: "POST",
url: baseurl+'area/area_delete',
async: false,
type: "POST",
data: "id="+val,
dataType: "html",
success: function(response)
{
$('#kt_modal_delete_area').empty().append(response);
$('#kt_modal_delete_area').addClass('show');
...
{
	var baseurl= $("#baseurl").val();
	$('#kt_modal_delete_area').removeClass('show');
	$('.modal-backdrop').removeClass('show');
	window.location.href = baseurl+'area';
}
