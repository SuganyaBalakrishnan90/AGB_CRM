					...
					<form name="city_edit_form" id="city_edit_form" method="POST" action="<?php echo base_url(); ?>city/city_update" enctype="multipart/form-data" onsubmit="return city_edit_validation();">
						...
						<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
							...
							<div class="row mb-6">
								...
								<div class="col-lg-8">
									<!--begin::Select-->
									<select class="form-select form-select-solid cdrop" data-control="select2" data-hide-search="true" id="zone_edit" name="zone_edit" onchange="get_area_edit(this.value);" >
							...
							<div class="row mb-6">
								...
								<div class="col-lg-8">
									<!--begin::Select-->
									<select class="form-select form-select-solid cdrop" data-control="select2" data-hide-search="true" id="area_edit" name="area_edit" >
											<?php 
							...
							<div class="row mb-6">
								...
								<div class="col-lg-8 fv-row fv-plugins-icon-container">
									<input type="text" name="city_edit" id="city_edit" class="form-control form-control-lg form-control-solid" placeholder="City Name" value="<?php echo $city_details->CITYNAME;?>">
