								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
											...
											<button type="button" class="btn btn-primary"  data-bs-toggle="modal" data-bs-target="#kt_modal_add_newitem">
									...
									<table class="table align-middle table-row-dashed table-striped table-hover fs-6 gy-1 gs-2" id="kt_datatable_dom_positioning">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
												...
												<th class="min-w-125px" style="width: 20%;" >Item Code</th>
												<th class="min-w-125px" style="width: 20%;" >Category</th>
												<th class="min-w-125px" style="width: 60%;" >Item Name</th>
												<th class="min-w-125px" style="width: 10%;" >Prefix</th>
												<!-- <th class="min-w-125px" style="width: 20%;" >Unit</th> -->
										...
										<tbody class="text-gray-600 fw-semibold">
											...
											<tr>
												...
												<td><?php echo $dlist['ITEM_CODE'];?></td>
												<td><?php echo $dlist['ITEM_CATEGORY'];?></td>
												<td><?php echo $dlist['ITEMNAME'];?></td>
												<td><?php echo $dlist['ITEM_PREFIX'];?></td>
												<td>
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="row">
							...
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="item_code" id="item_code" class="form-control form-control-lg form-control-solid">
								<div class="fv-plugins-message-container invalid-feedback" id="item_code_err"></div>
							</div>
							<!--end::Col-->
							<!--begin::Label-->
							<label class="col-lg-1 col-form-label required fw-semibold fs-6">Category</label>
							<!--end::Label-->
							<!--begin::Left Section-->
							<div class="col-lg-2 fv-row">
							<!--begin::Select-->
								<select class="form-select form-select-solid" data-control="select2" name="category_item"  id="category_item" data-hide-search="true">
								...
								<!--end::Select-->
								<div class="fv-plugins-message-container invalid-feedback" id="category_item_err"></div>
							</div>
							<!--end::Left Section-->
							<!--begin::Label-->
							...
							<!--end::Col-->
							<!--begin::Label-->
							<label class="col-lg-2 col-form-label required fw-semibold fs-6">Item Prefix</label>
							<!--end::Label-->
							<!--begin::Col-->
							<div class="col-lg-1 fv-row fv-plugins-icon-container">
								<input type="text" name="prefix_item" id="prefix_item" class="form-control form-control-lg form-control-solid">
								<div class="fv-plugins-message-container invalid-feedback" id="prefix_item_err"></div>
							</div>
							<!--end::Col-->
							<!--begin::Label-->
...
function new_item_validation()
{
    ...
    if(item_code.trim()=='')
    {
        $('#item_code_err').html('Enter Item Code!');
        err++;
    }
    else
    ...
    if(category_item.trim()=='')
    {
        $('#category_item_err').html('Select Category!');
        err++;
    }
    else

    {
    	$('#category_item_err').html('');
    ...
    var prefix_item = $('#prefix_item').val();
    if(prefix_item.trim()=='')
    {
        $('#prefix_item_err').html('Enter Item Prefix!');
        err++;
    }
    else

    {
    	$('#prefix_item_err').html('');

    }

    var unit_item = $('#unit_item').val();
    if(unit_item.trim()=='')
    {
        $('#unit_item_err').html('Select Unit!');
        err++;
    }
    else
