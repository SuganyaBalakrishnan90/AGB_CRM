                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 20px !important;padding-left:0px !important; ">
                                ...
                                <p style="padding-left: 10px;"><?php echo $party_detail->ADDRESS1;echo $party_detail->CITY;echo $party_detail->STATE; echo $party_detail->COUNTRY; echo $party_detail->PINCODE;?></p>
                        ...
                        <tr>
                            <td colspan="2" style="font-size: 20px !important;">
                                ...
                                <label style="padding-left:10px !important;">
                                    <span><?php echo $party_detail->EMAIL; ?>&nbsp;</span>
                                    <!-- <span style="font-weight: bold;"></span> -->
                                    <span><?php //echo $party_detail->PHONE2; ?></span>
                                </label>
                            </td>
                        ...
                        $tracking_id=$cpos['tracking_id'];
                         ...
                         <!--  <tr>
                                 <td colspan="2" style="font-size: 20px;">
                                    <label style="text-align-last: start;">
                                        <span>Tracking ID</span>&emsp;&emsp;&emsp;&nbsp;&nbsp;
                                        <span style="text-align-last:end !important;">&nbsp;&nbsp; :</span>
                                    </label>&nbsp;&nbsp;
                                    <label><?php echo $tracking_id;?></label>
                                </td> 
                             </tr>-->
                             <tr>
                                ...
                                <td colspan="2" style="font-size: 20px;">
                                    ...
                                    <label><?php echo $prd_count;?></label>
                                </td>
                            </tr>
