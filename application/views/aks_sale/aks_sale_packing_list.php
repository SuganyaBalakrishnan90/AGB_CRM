									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body py-4">
											<div class="row">
												...
												<div class="col-lg-2">
													<button class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#sales_scanned1" onclick="view_sale1()"  id="click_to_scan">Ok</button>
												</div>
												<div class="col-lg-3">
					...
					<div class="col-lg-12">
					    ...
					    <div class="row">
							...
							<div class="d-flex align-items-center justify-content-center mt-2">
								...
								<label class="col-lg-2 col-form-label fw-bold fs-3">1200.00</label>
						    </div>
