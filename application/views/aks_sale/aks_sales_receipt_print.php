                    ...
                    <table id="particular">
                        ...
                        <tbody style="font-size:14px !important;">
                            ...
                            <tr >
                                ...
                                <td style="text-align: center;border-bottom-style: hidden;"><?php echo $cprint['sale_price']; ?>/<?php echo number_format($prdname->AKS_PRD_WT/1000,3); ?></td>
                                <td style="text-align:center;border-bottom-style: hidden;"><?php echo number_format($cprint['product_wgt']/1000,3); ?></td>
                ...
                <tr style="border-top-style: hidden;" >
                    ...
                    <?php  } ?>
                         ...
                         <tfoot>
                            <tr>
                                ...
                                <td class="ft_wgt" style="text-align:center;"><?php echo number_format($sprint['sale_net_amt'],2); ?></td>
                            </tr>
                        </tfoot>
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="ft_wgt" style="text-align:center;"><?php echo number_format($wgtss/1000,3); ?></td>
                                <td class="ft_wgt" style="text-align:center;"><?php echo number_format($sprint['sale_prd_tot_amt'],2); ?></td>
                            </tr>
                        </tfoot>
                       <tfoot>
                            <tr>
                    ...
                    <table id="charges">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo number_format($sprint['sale_net_amt'],2); ?></td>
