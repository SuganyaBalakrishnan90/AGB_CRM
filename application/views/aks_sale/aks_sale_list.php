										...
										<div class="card-body py-4">
											...
											<div class="col-lg-4">
												<div class="d-flex justify-content-end"
													...
													<button type="button"
														class="btn btn-sm btn-outline btn-outline-solid btn-outline-warning btn-active-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_generate_overall">Generate
													</button>
													<!--begin::Filter-->
													<button type="button"
											...
											<table id="" class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2 dataTable no-footer">
												...
												<tbody class="text-gray-600 fw-semibold">
													<?php $i=0;  foreach($sale_list as $i=> $slist){ 
													...
													<tr>
														...
														<?php if($slist['status'] =='Y' || $slist['status'] =='P'  ){ ?>
															<div class="form-check form-check-sm form-check-custom">
																<input class="form-check-input" type="checkbox" name="checked[]" id="checked<?php echo $i; ?>" value="<?php echo $slist['sale_id']; ?> "/>
															</div>
															<?php } ?>
														</td>
														<!-- <td><?php  //echo $i+1;  ?></td> -->
														...
														echo $slist['sale_deliverymode'];
														}
														else{
															echo $slist['delivery_by'];
														}
														?></td>
														<td>
														...
														<label class="col-form-label fw-semibold fs-7"><span style="background-color:#ffc700;border-radius: 8px;padding: 5px 10px 5px 10px;" >Partial-Ready For Packing</span></label>

																<?php } ?>
																<?php if($slist['status'] =='F'){ ?>
														<label class="col-form-label fw-semibold fs-7"><span style="background-color:#f1416c;border-radius: 8px;padding: 5px 10px 5px 10px;" >Ready For Packing</span></label>

																<?php } ?>
														<?php if($slist['sale_deliverymode'] =='Direct'){ ?>
															<?php if($slist['status'] =='S'){ ?>
														<label class="col-form-label fw-semibold fs-7"><span style="background-color:#00B050;border-radius: 8px;padding: 5px 10px 5px 10px;" >Delivered</span></label>
														...
														<!--<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delivery_info" onclick="change_delivery(<?php echo $slist['sid'];?>)">
															...
															<?php 
															$get_id=$this->db->query("select * from AKS_SALE_ENTRY where status='D' and sale_id like '".$slist['sale_id']."' ")->result_array();
															$row_count=count($get_id);
															if($row_count>0){
															// if($slist['status'] !='Y'){ 
																foreach($get_id as $list){
																
																?>
															<span class="text-end">
															<a href="<?php echo base_url(); ?>Aks_sale/sale_print_pos/<?php echo $list['sid'];?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  title="Print Shipping Pos">
														...
														if($slist['status'] =='Y' || $slist['status'] =='P'  ){ ?>
														<span class="text-end">
															<a href="<?php echo base_url();?>Aks_sale/packing/<?php  echo $slist['sid'];?>" target="_blank" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm"  title="Packing Process">
											...
											<input type="hidden" name="sale_count" id="sale_count" value="<?php echo $i; ?>">
						 ...
						 <div class="row">
						   ...
						   <div class="row mt-4">
						    ...
						    <div class="row mt-4">
										 ...
										 <div class="col-lg-4  text-start" id="sale_delivery_by">
											<label class="col-form-label fw-bold fs-5">Delivery By  &emsp;</label>
											<label class="col-form-label fw-bold fs-3"><sapn id="delivery_by"></sapn></label>
								 	    </div>
										 <div class="col-lg-4  text-start" id="sale_tracking_id">
											<label class="col-form-label fw-bold fs-5">Tracking ID  &emsp;</label>
											<label class="col-form-label fw-bold fs-3"><sapn id="label_tracking_id"></sapn></label>
								 	    </div>
							</div>
						   <div class="row mt-4" id="sale_payment_details">
	...
	<input type="hidden" id="baseurl" value="<?php echo base_url();?>">
		...
		function full_packing() 
			{
				// value=$(this).val();
				// alert(value);
				$('#full_packing_form').attr('action', "<?php echo base_url(); ?>Aks_sale/full_packing");
		...
		<script>
			function date_fill_sale_list()
			{
				...
				else if (dt_fill_sale_list == "custom_date")
				{
					today_dt_nontag_list.style.display = "none";
					monthly_dt_nontag_list.style.display = "none";
