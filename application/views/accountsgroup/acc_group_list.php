									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="row" style="padding: 1rem 1rem 0rem 1rem !important;">
											...
											<select class="form-select form-select-solid" data-control="select2" data-hide-search="true"  id="acc_grp" name="acc_grp"  >
													...
													<option value="<?php echo $acc_list['GROUP_SNO']; ?>" <?php if($acc_grp==$acc_list['GROUP_SNO']){echo "selelcted"; } ?> > <?php echo $acc_list['GROUP_NAME']; ?> </option>
													<?php 
													}
													?>
												</select>
									...
									<table class="table align-middle table-row-dashed table-striped table-hover fs-6 gy-5" id="kt_datatable_dom_positioning">
										...
										<thead>
											...
											<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
												...
												<!-- <th class="min-w-25px" style="width: 10%;">Status</th> -->
										...
										<tbody class="text-gray-600 fw-semibold">
											...
											<tr>
												...
												<td><?php echo $aglist['GROUP_NAME'];?></td>
												<td><?php echo $aglist['UNDER_GROUP'];?></td>
												<td><?php echo $aglist['DESCRIPTION'];?></td>
												<td><?php echo $aglist['CHK_PREDEFINED'];?></td>
												<!--begin::Action=-->
												<td>
													<?php if($aglist['CHK_PREDEFINED']=='N' ){?>
													<span class="text-end">
														<!-- <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_viewaccgroup">
														<i class="bi bi-eye-fill eyc"></i>
													</a> -->
													<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="modal" data-bs-target="#kt_modal_editaccgroup" onclick="acc_grp_edit('<?php echo $aglist['GROUP_SNO'];?>')">
													...
													<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_delete_accgroup" onclick="acc_grp_delete('<?php echo $aglist['GROUP_SNO'];?>')">
...
$('#kt_datatable_dom_positioning').DataTable( {
    ...
    var title = $('title').text() + ' | ' + 'Accounts Group';
