...
<body data-kt-name="metronic" id="kt_body"
											...
											<div class="col-lg-8">
												<div class="row">
													<div class="col-lg-3">
														...
														<div class="text-center">
															<label class="text-success fs-3 fw-bold"><?php echo $get_party_name; ?></label>
														</div>
													</div>
													<div class="col-lg-3">
														<div class="text-center">
													...
													<div class="col-lg-3">
														...
														<div class="text-center">
															<label class="text-success fs-2 fw-bold"><?php echo $bal_hl_amt; ?></label>
														</div>
													</div>
												</div>
											</div>
												...
												<div class="d-flex justify-content-end"
													...
													<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
														<div class="px-7 py-5" data-kt-user-table-filter="form">
															<form method="POST" action="<?php echo base_url(); ?>Handloan/handloan_history/<?php echo $hl_id; ?>">	
															<div class="mb-2">
																<label class="form-label fs-6 fw-semibold">User</label>
																<select class="form-select form-select-solid"
																	data-control="select2" data-close-on-select="true"
																	data-allow-clear="true" multiple="multiple" id="hl_utype" name="hl_utype">
																	...
																	<option value="<?php echo $hlist['ADDED_USER']; ?>" 
																		...
																		<?php echo $hlist['ADDED_USER']; ?></option>
																	<?php  }?>
																</select>
															</div>
															<div class="mb-2">
																<label class="form-label fs-6 fw-semibold">Type</label>
																<select class="form-select form-select-solid"data-control="select2" data-hide-search="true" id="hl_type" name="hl_type">	
															...
															<div class="mb-2">
																				...
																				<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="dt_fill_hl_his_list" name="dt_fill_hl_his_list" onchange="date_fill_hl_his_list();">	
										...
										<div class="row">
											<table id=""
												...
												<tbody class="text-gray-600 fw-semibold">
													<?php  foreach($HL_historty_list as $i=> $hlist){ 

														$date=date('d-m-Y',strtotime($hlist['HL_DATE']));
														$time=date('H:i',strtotime($hlist['ADDED_TIME']));
													...
													<tr>
														...
														<td><span><?php echo $time; ?></span>
														  ...
														  ?></span></td>
														<td><?php echo $hlist['ADDED_USER']; ?></td>
														<td>
											...
											<?php $paging_info = get_paging_info1($count,10,$c_page); ?>
														...
														<form   method="POST" id="filter_form" action="" enctype="multipart/form-data" >
															...
															<input type="hidden" id="hl_type" name="hl_type"  value="<?php echo $utype; ?>">
	...
	<script>
		function date_fill_hl_his_wallet_history() {
			var dt_fill_hl_his_wallet_history = document.getElementById('dt_fill_hl_his_wallet_history').value;
			var today_dt_hl_his_wallet_history = document.getElementById('today_dt_hl_his_wallet_history');
			var week_from_dt_hl_his_wallet_history = document.getElementById('week_from_dt_hl_his_wallet_history');
			var week_to_dt_hl_his_wallet_history = document.getElementById('week_to_dt_hl_his_wallet_history');
			var monthly_dt_hl_his_wallet_history = document.getElementById('monthly_dt_hl_his_wallet_history');
			var from_dt_hl_his_wallet_history = document.getElementById('from_dt_hl_his_wallet_history');
			var to_dt_hl_his_wallet_history = document.getElementById('to_dt_hl_his_wallet_history');
			var from_date_fillter_hl_his_wallet_history = document.getElementById('from_date_fillter_hl_his_wallet_history');
			var to_date_fillter_hl_his_wallet_history = document.getElementById('to_date_fillter_hl_his_wallet_history');

			if (dt_fill_hl_his_wallet_history == "today") {
				today_dt_hl_his_wallet_history.style.display = "block";
				monthly_dt_hl_his_wallet_history.style.display = "none";
				from_dt_hl_his_wallet_history.style.display = "none";
				to_dt_hl_his_wallet_history.style.display = "none";
				week_from_dt_hl_his_wallet_history.style.display = "none";
				week_to_dt_hl_his_wallet_history.style.display = "none";
				$("#today_date_fillter_hl_his_wallet_history").flatpickr({
					dateFormat: "d-m-Y",
				});
			}
			else if (dt_fill_hl_his_wallet_history == "week") {
				today_dt_hl_his_wallet_history.style.display = "none";
				week_from_dt_hl_his_wallet_history.style.display = "block";
				week_to_dt_hl_his_wallet_history.style.display = "block";
				monthly_dt_hl_his_wallet_history.style.display = "none";
				from_dt_hl_his_wallet_history.style.display = "none";
				to_dt_hl_his_wallet_history.style.display = "none";
				...
				$('#week_from_date_fillter_hl_his_wallet_history').val(firstday);
				$('#week_to_date_fillter_hl_his_wallet_history').val(lastday);

			}
			else if (dt_fill_hl_his_wallet_history == "monthly") {
				today_dt_hl_his_wallet_history.style.display = "none";
				monthly_dt_hl_his_wallet_history.style.display = "block";
				from_dt_hl_his_wallet_history.style.display = "none";
				to_dt_hl_his_wallet_history.style.display = "none";
				week_from_dt_hl_his_wallet_history.style.display = "none";
				week_to_dt_hl_his_wallet_history.style.display = "none";
				$("#monthly_date_fillter_hl_his_wallet_history").flatpickr({
					dateFormat: "m-Y",
				});
			}
			else if (dt_fill_hl_his_wallet_history == "custom_date") {
				today_dt_hl_his_wallet_history.style.display = "none";
				monthly_dt_hl_his_wallet_history.style.display = "none";
				from_dt_hl_his_wallet_history.style.display = "block";
				to_dt_hl_his_wallet_history.style.display = "block";
				week_from_dt_hl_his_wallet_history.style.display = "none";
				week_to_dt_hl_his_wallet_history.style.display = "none";

				$("#from_date_fillter_hl_his_wallet_history").flatpickr({
					dateFormat: "d-m-Y",
				});
				$("#to_date_fillter_hl_his_wallet_history").flatpickr({
					dateFormat: "d-m-Y",
				});
			}
			else {
	...
	<script>
		$("#kt_datatable_non_tagged_wallet_history").DataTable({
			...
			// $('#view_hl_his_wallet_table').wrap('<div class="dataTables_scroll" />');
	</script>
	<script>
			function date_fill_hl_his_list()
			{
				...
				else if (dt_fill_hl_his_list == "custom_date")
				{
					today_dt_hl_his_list.style.display = "none";
					monthly_dt_hl_his_list.style.display = "none";
		...
		<script>
			function date_fill_hl_his_wallet()
			{
				var dt_fill_hl_his_wallet = document.getElementById('dt_fill_hl_his_wallet').value;
				var today_dt_hl_his_wallet = document.getElementById('today_dt_hl_his_wallet');
				var week_from_dt_hl_his_wallet = document.getElementById('week_from_dt_hl_his_wallet');
				var week_to_dt_hl_his_wallet = document.getElementById('week_to_dt_hl_his_wallet');
				var monthly_dt_hl_his_wallet = document.getElementById('monthly_dt_hl_his_wallet');
				var from_dt_hl_his_wallet = document.getElementById('from_dt_hl_his_wallet');
				var to_dt_hl_his_wallet = document.getElementById('to_dt_hl_his_wallet');
				var from_date_fillter_hl_his_wallet = document.getElementById('from_date_fillter_hl_his_wallet');
				var to_date_fillter_hl_his_wallet = document.getElementById('to_date_fillter_hl_his_wallet');

				if (dt_fill_hl_his_wallet == "today") 
				{
					today_dt_hl_his_wallet.style.display = "block";
					monthly_dt_hl_his_wallet.style.display = "none";
					from_dt_hl_his_wallet.style.display = "none";
					to_dt_hl_his_wallet.style.display = "none";
					week_from_dt_hl_his_wallet.style.display = "none";
					week_to_dt_hl_his_wallet.style.display = "none";
					$("#today_date_fillter_hl_his_wallet").flatpickr({
								dateFormat: "d-m-Y",
							});
				}
				else if (dt_fill_hl_his_wallet == "week")
				{
					today_dt_hl_his_wallet.style.display = "none";
					week_from_dt_hl_his_wallet.style.display = "block";
					week_to_dt_hl_his_wallet.style.display = "block";
					monthly_dt_hl_his_wallet.style.display = "none";
					from_dt_hl_his_wallet.style.display = "none";
					to_dt_hl_his_wallet.style.display = "none";
					...
					var lastday = new Date(curr.setDate(last)).toISOString().slice(0,10);
					lastday = lastday.split("-").reverse().join("-");
					$('#week_from_date_fillter_hl_his_wallet').val(firstday);
					$('#week_to_date_fillter_hl_his_wallet').val(lastday);
					
				}
				else if (dt_fill_hl_his_wallet == "monthly")
				{
					today_dt_hl_his_wallet.style.display = "none";
					monthly_dt_hl_his_wallet.style.display = "block";
					from_dt_hl_his_wallet.style.display = "none";
					to_dt_hl_his_wallet.style.display = "none";
					week_from_dt_hl_his_wallet.style.display = "none";
					week_to_dt_hl_his_wallet.style.display = "none";
					$("#monthly_date_fillter_hl_his_wallet").flatpickr({
								dateFormat: "m-Y",
							});
				}
				else if (dt_fill_hl_his_wallet == "custom_date")
				{
					today_dt_hl_his_wallet.style.display = "none";
					monthly_dt_hl_his_wallet.style.display = "none";
					from_dt_hl_his_wallet.style.display = "block";
					to_dt_hl_his_wallet.style.display = "block";
					week_from_dt_hl_his_wallet.style.display = "none";
					week_to_dt_hl_his_wallet.style.display = "none";

					$("#from_date_fillter_hl_his_wallet").flatpickr({
								dateFormat: "d-m-Y",
							});
					$("#to_date_fillter_hl_his_wallet").flatpickr({
								dateFormat: "d-m-Y",
							});
				}
				else
