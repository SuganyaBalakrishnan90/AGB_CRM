	...
	<div class="modal-content rounded">
		<div class="swal2-icon swal2-warning swal2-icon-show" style="display: flex;">
			...
			<div class="d-flex flex-center flex-row-fluid pt-12">
				...
				<button type="submit" class="btn btn-primary " data-bs-dismiss="modal" onclick="removeprd('<?php echo $pur_detail->pur_id;?>')" >Yes, delete!</button>
				<!-- onclick="removeprd('<?php echo $pur_detail->pur_id;?>')" -->
			</div><br><br>
		<!-- </div> 