													...
													<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
														...
														<form id="kt_modal_export_users_form" class="form" action="#">
															...
															<div class="fv-row mb-10">
																<!--begin::Label-->
																<label class="fs-6 fw-semibold form-label mb-2">Select Designation:</label>
																<!--end::Label-->
																<!--begin::Input-->
																<select name="role" data-control="select2" data-placeholder="Select Company" data-hide-search="true" class="form-select form-select-solid fw-bold">
																	<option></option>
																	<option value="Designation Details">Designation Details</option>
			...
			<div class="modal-dialog modal-m">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						<!--begin::Heading-->
						<div class="mb-13 text-center">
							<h1 class="mb-3">Designation Details</h1>
						</div>
						<!--end::Heading-->
						<div class="row mb-6">
							<!--begin::Label-->
							...
							<div class="row mb-6">
								<!--begin::Label-->
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-container">
													<input type="text" name="company" class="form-control form-control-lg form-control-solid" placeholder="Designation Name" Value="Accounts" disabled>
...
var title = $('title').text() + ' | ' + 'Designation';
