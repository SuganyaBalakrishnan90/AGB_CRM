				...
				<div class="modal-content rounded">
					...
					<div class="modal-body pt-0 pb-15 px-5 px-xl-20">
						...
						<div class="mb-7 text-center">
							<h1>Modify On Account - Handloan Payments Entry</h1>
						</div>
						<!--end::Heading-->
						<form id="general_validate" style="width: 100%;" method="POST" action="<?php echo base_url(); ?>handloanentry/handloanentry_update" enctype="multipart/form-data" onsubmit="return handloanentry_edit_validation();">
								...
								<div class="row">
									...
									<div class="col-lg-2 fv-row">
										<div class="d-flex align-items-center">
											...
											<input type="date" class="form-control form-control-solid" name="add_date_hand_loan_entrys" placeholder="Select Date" id="add_date_hand_loan_entrys_edit" value="<?php echo $voucher_master_details->TRANSDATE;?>" />
										</div>
										<div class="fv-plugins-message-container invalid-feedback" id="add_date_hand_loan_entrys_edit_err"></div>
									</div>
									<!--end::Col-->
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<?php $leddet = $this->Handloanentry_model->get_ledger_details_by_name($hl_payment_details->PAID_BY);?>
									<div class="row">
