						...
						<div id="kt_toolbar_container" class="container-fluid d-flex align-items-center">
							...
							<div class="flex-grow-1 flex-shrink-0 me-5">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Cashbook List
									<!--begin::Separator-->
							...
							<div class="row gy-5 g-xl-8">
								...
								<div class="col-xxl-8">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
				                        ...
				                        <?php } ?>
										<form action="<?php echo base_url();?>cashbook" method="post">
											...
											<table class="table align-middle table-row-dashed table-striped table-hover fs-7 gy-1 gs-2" id="kt_datatable_dom_positioning">
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													<?php $i=1; $totdeb=$totcre=0;
														...
														$vStartDate = $fyear_start_date;
														$vEndDate = $fyear_end_date;
		        										...
		        										$alopbal = $this->Cashbook_model->get_account_ledger_opening_balance();
		        										if(count((array)$alopbal)>0)
		        										{
		        											$vOpeningBalance = $alopbal->OP_BALANCE;
		        											$vOpeningSide = $alopbal->OP_SIDE;
		        										}

		        										$opbaldet = $this->Cashbook_model->get_op_balance($vStartDate,$vEndDate);
		        										$vTotDebit = $opbaldet->TOTALDEBITS;
		        										$vTotCredit = $opbaldet->TOTALCREDITS;

		        										if(strtolower($vOpeningSide)=='dr')
		        										{
		        											$vTotDebit = $vTotDebit + $vOpeningBalance;
		        										}
		        										elseif(strtolower($vOpeningSide)=='cr')
		        										{
														...
														{
														    $vClosingBalance = 0;
														    $vClosingSide = $vOpeningSide;
														}

														if($vTotBalance > 0)
														{
													         $vOp_Debit = $vTotBalance;
													         $vOp_Credit = '';
													         $opdeb = $vTotBalance;
													         $opcre = 0;

													         $opdebval = number_format($opdeb,2);
													         $opcreval = '';
												    	}
													    elseif($vTotBalance < 0)
													    {
													        $vOp_Debit = '';
													        $vOp_Credit = abs($vTotBalance);
													        $opdeb = 0;
													        $opcre = abs($vTotBalance);

													        $opdebval = '';
													        $opcreval = number_format($opcre,2);
													    }
													    else
													    {
													        $vOp_Debit = '';
													    ...
													    <tr>
													    	...
													    	<td><b><?php echo $opdebval;?></b></td>
													    	<td><b><?php echo $opcreval;?></b></td>
													    </tr>
													<?php foreach($cashbook_list as $dlist){
												...
												<tfoot>
													<tr>
														...
														<td></td>
														<td><b>Total</b></td>
														<td style="text-align:right"><b><?php echo number_format($totdeb,2);?></b></td>
														<td style="text-align:right"><b><?php echo number_format($totcre,2);?></b></td>
													</tr>
													<tr>
														<td></td>
														<td></td>
														...
														<td style="text-align:right"><b><?php echo number_format((($opdeb+$totdeb)-($opcre+$totcre)),2);?></b></td>
														<td></td>
													</tr>
												</tfoot>
												<!--end::Table body-->
