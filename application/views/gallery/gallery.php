										...
										<div class="card-body py-4">
											...
											<div class="row">
												...
												<div class="col-lg-2 fv-row fv-plugins-icon-container">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="item" name="item" onchange="get_subitem()">	
													<option value="">All</option>
																							
																				<optgroup label="Gold" value="1">
																				<?php foreach($gold_item as $plist){ ?>
																	<option value="gold_<?php echo $plist['SNO']; ?>" <?php if(isset($item_detail[1])){ if($item_detail[1]==$plist['SNO']){ echo 'selected'; } } ?>><?php echo $plist['ITEMNAME']; ?></option>
																	...
																	<option value="silver_<?php echo $plist['SNO']; ?>"  <?php if(isset($item_detail[1])){ if($item_detail[1]==$plist['SNO']){ echo 'selected'; } } ?>><?php echo $plist['ITEMNAME']; ?></option>
												...
												<div class="col-lg-2 fv-row fv-plugins-icon-container">
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" id="subitem" name="subitem">	
														<option value="">All</option>
											...
											<?php  foreach($subitem as $slist){  $img_count=0;?>
												...
												<div class="col-lg-2">
													...
													<a class="d-block overlay"  href="<?php echo base_url(); ?>Gallery/gallery_images/<?php echo $slist['SUB_ID']; ?> ">
													    <!--begin::Image-->
