...
// echo $data['dt_fill'];
    ...
    public function jewel_settlement_add($id)
    {
       ...
       $party_details=$data['party_details'] = $this->db->query("select PID, NAME, DOORNO, ADDRESS1, ADDRESS2, CITY, AREA, ZONE_SNO, PHONE,PHOTO, OTHER_PHOTO, RATING, TYPE_OF_RECORD, SIGNATURE from PARTIES where PID='".$loan_details->PID."'")->row();
