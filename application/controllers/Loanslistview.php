    ...
    public function index()
    {
      ...
      //   //To dispaly area list
       ...
       if($amt_loanlistview == "="){
        ...
        if($cmplstvw!='' || $zonelst!='' || $area !='' || $ctyvw!='' || $vlstvw!='' || $stlstvw!=''  || $area!='' || $intlstvw!='' || $intgrplstvw!='' || $loanall!='' || $loantypselect!='' || $jwlall!='' || $jwltypselect!='' || $date!='' || $amtvw!='' ||$wghtvw!='' || $status!='' || $bank_status!='' || $alter_remarks!='')
        {
